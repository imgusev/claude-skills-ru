---
name: "cs-webinar"
description: "/cs:webinar — Вебинар и воркфлоу по маркетингу виртуальных мероприятий. Спланируйте вебинар с нуля (в обратном порядке от бизнес-цели), спасите того, чьи показатели разочаровали (оцените воронку, почините сломанную сцену), или превратите прошедший вебинар в вечнозеленый механизм привлечения клиентов по запросу. Охватывает всю воронку: регистрацию, рекламную полосу, показ, участие в прямом эфире, от начала до конца и сегментированное последующее наблюдение. Рассматривает вебинар как воронку, а не как мероприятие."
---

# /cs:webinar — Маркетинг вебинаров и виртуальных мероприятий { #cswebinar--webinar--virtual-event-marketing }
...
- Агент: [`cs-webinar-marketer`](../agents/marketing/cs-webinar-marketer.md)
- Скилл: [`webinar-marketing`](../marketing-skill/skills/webinar-marketing/SKILL.md)
