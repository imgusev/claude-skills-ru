---
name: wiki-log
description: "Показывать последние записи из вики-журнала LLM (wiki/log.md). Использует стандартизированный формат заголовка ## [ГГГГ-ММ-ДД], поэтому работает grep + tail. Использование /wiki-журнал [--last N] [--op ingest|query|lint|...]"
---
