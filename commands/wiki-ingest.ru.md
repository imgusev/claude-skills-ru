---
name: wiki-ingest
description: "Загрузите исходный файл из raw/ в LLM Wiki — прочитайте, обсудите, напишите сводную страницу, обновите перекрестные ссылки на 5-15 страницах, восстановите индекс, добавьте в журнал. Использование /wiki-ingest <путь к источнику>"
---
