---
description: "Запустите воркфлоу ежеквартальной очистки флагов функций в текущем репозитории"
---
...
2. Для каждого кандидата определите вводящий PR/issue и нынешний владелец
