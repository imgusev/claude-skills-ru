---
description: "Интерактивный мастер для разработки и проверки эксперимента по созданию хаоса"
---
...
- Известна ошибка бюджета (или используйте значения по умолчанию)
