---
name: tc
description: "Отслеживайте технические изменения с помощью структурированных записей, конечного автомата и хэндоффа сеанса. Использование: /tc <инициализировать|создать|обновить|статус|возобновить|закрыть|экспортировать|дашборд> [аргументы]"
---

# /tc — Отслеживание технических изменений { #tc--technical-change-tracker }
