...
description: "Гибкий агент владельца продукта для эпической разбивки, планирования спринта, уточнения бэклога и создания пользовательских историй, соответствующих требованиям ИНВЕСТОРОВ. Используйте при подготовке работы для команды разработчиков — например, при разбиении большого epic на истории, соответствующие инвестиционным требованиям, с критериями приемлемости или при доработке беспорядочного бэклога перед планированием спринта."
...
**Основной скилл:** `../../product-team/agile-product-owner/`

### Все организованные скиллы { #all-orchestrated-skills }

| # | Скилл | Местоположение | Основной инструмент |
|---|-------|----------|-------------|
| 1 | Гибкий владелец продукта | `../../product-team/agile-product-owner/` | user_story_generator.py |
| 2 | Инструментарий менеджера по продукту | `../../product-team/skills/product-manager-toolkit/` | rice_prioritizer.py |
...
1. **Шаблон планирования спринта**
   - **Местоположение:** `../../product-team/agile-product-owner/skills/agile-product-owner/assets/sprint_planning_template.md`
...
2. **Шаблон истории пользователя**
   - **Местоположение:** `../../product-team/agile-product-owner/skills/agile-product-owner/assets/user_story_template.md`
   - ** Пример использования:** Согласованный формат истории, структура критериев приемлемости

3. **шаблон для ввода РИСА**
   - **Местоположение:** `../../product-team/skills/product-manager-toolkit/assets/rice_input_template.csv`
