---
title: "Протокол взаимодействия между агентами { #inter-agent-protocol } — Агентский скилл для руководителей"
description: "Протокол межагентной связи для команд агентов C-suite. Протокол межагентной связи для команд агентов C-suite. Определяет синтаксис вызова. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/agent-protocol/SKILL.md">Источник</a></span>
</div>
...
| Юридическая информация, контракты, временные рамки | GC | Риск оговорки, владение интеллектуальной собственностью, нормативные триггеры |
...
Цикл не заканчивается при доставке. После того, как основатель ответит:
...
8. ** Риски конкретны.** Не "могут быть риски" — "если произойдет X, Y сломается, что обойдется в Z долларов".
