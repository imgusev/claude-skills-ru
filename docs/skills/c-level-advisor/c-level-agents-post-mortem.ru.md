...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/skills/post-mortem/SKILL.md">Источник</a></span>
</div>
...
- Родной брат: [`/em:postmortem`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/executive-mentor/skills/postmortem/SKILL.md) — состязательное вскрытие с единоличным решением
