...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/skills/c-level-agents/SKILL.md">Source</a></span>
</div>
...
See [`references/persona-voices.md`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/references/persona-voices.md) for voice specs.
...
- **llm-wiki** — optional persistent memory bridge (see [`references/llm-wiki-bridge.md`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/references/llm-wiki-bridge.md))
...
- [Parent c-level CLAUDE.md](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/CLAUDE.md)
- [Existing executive-mentor sibling](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/executive-mentor)
