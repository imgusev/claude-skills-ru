...
<span class="meta-badge">:material-github: <a href="https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/c-level-agents/skills/cpo-review/SKILL.md">Source</a></span>
</div>
...
- Agent: [`cs-cpo-advisor`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/c-level-agents/agents/cs-cpo-advisor.md)
- Skill: [`cpo-advisor`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/skills/cpo-advisor/SKILL.md)
