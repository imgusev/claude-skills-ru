...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/skills/founder-mode/SKILL.md">Source</a></span>
</div>
...
- Agent: [`cs-chief-of-staff`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/agents/cs-chief-of-staff.md) — does the routing
- Skill: [`chief-of-staff`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/chief-of-staff/SKILL.md) — routing logic
- Skill: [`context-engine`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/context-engine/SKILL.md) — loads context
