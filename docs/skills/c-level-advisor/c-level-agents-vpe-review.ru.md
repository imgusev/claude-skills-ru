---
title: "/cs:vpe-ревью — Форсирующие вопросы VPE { #csvpe-review--vpe-forcing-questions } — Агентский скилл для руководителей"
description: "/cs:vpe-ревью <плана> — Пропускная способность - первый вице-президент по инженерным вопросам проводит опрос любого плана, который касается поставок. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---

# /cs:vpe-ревью — Форсирующие вопросы VPE { #csvpe-review--vpe-forcing-questions }
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/skills/vpe-review/SKILL.md">Источник</a></span>
</div>
...
- Перед реструктуризацией английских команд (разделение/слияние отрядов, добавление племен)
...
- `cs-chro-advisor` агент — по вопросам оптимизации воронки найма / выравнивания уровня
...
- Агент: [`cs-vpe-advisor`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/agents/cs-vpe-advisor.md)
- Скилл: [`vpe-advisor`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/vpe-advisor/SKILL.md)
- Смежный: [`engineering/slo-architect`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/slo-architect), [`engineering/feature-flags-architect`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/feature-flags-architect), [`engineering/chaos-engineering`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/chaos-engineering)
