...
<span class="meta-badge">:material-github: <a href="https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/c-level-agents/skills/ciso-review/SKILL.md">Source</a></span>
</div>
...
- Agent: [`cs-ciso-advisor`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/c-level-agents/agents/cs-ciso-advisor.md)
- Skill: [`ciso-advisor`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/skills/ciso-advisor/SKILL.md)
- Compliance: [`ra-qm-team`](https://github.com/<GH_USER>/<REPO>/tree/main/ra-qm-team)
