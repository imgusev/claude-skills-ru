...
<span class="meta-badge">:material-github: <a href="https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/c-level-agents/skills/brief/SKILL.md">Source</a></span>
</div>
...
- Skills: [`context-engine`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/skills/context-engine/SKILL.md), [`board-meeting`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/skills/board-meeting/SKILL.md)
