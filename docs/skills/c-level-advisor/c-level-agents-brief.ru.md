---
title: "/cs:brief — Краткое изложение стратегии на одной странице { #csbrief--one-page-strategy-brief } — Агентский скилл для руководителей"
description: "/cs:краткое изложение <тема> — Сгенерируйте одностраничное краткое изложение стратегии на основе учета рабочего времени. Первый шаг в стратегическом. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/skills/brief/SKILL.md">Источник</a></span>
</div>
...
- Скиллы: [`context-engine`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/context-engine/SKILL.md), [`board-meeting`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/board-meeting/SKILL.md)
