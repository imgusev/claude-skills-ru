...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/skills/execute/SKILL.md">Источник</a></span>
</div>
...
- Скиллы: [`coo-advisor`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/coo-advisor/SKILL.md), [`strategic-alignment`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/strategic-alignment/SKILL.md), [`change-management`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/change-management/SKILL.md)
- Агент: [`cs-coo-advisor`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/agents/cs-coo-advisor.md)
