...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/skills/founder-mode/SKILL.md">Источник</a></span>
</div>
...
- Агент: [`cs-chief-of-staff`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/agents/cs-chief-of-staff.md) — выполняет ли маршрутизация
- Скилл: [`chief-of-staff`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/chief-of-staff/SKILL.md) — логика маршрутизации
- Скилл: [`context-engine`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/context-engine/SKILL.md) — загружает контекст
