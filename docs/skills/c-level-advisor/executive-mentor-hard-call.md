...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/executive-mentor/skills/hard-call/SKILL.md">Source</a></span>
</div>
...
- **What you'll say** (honest, direct, compassionate — see [`references/hard_things.md`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/executive-mentor/skills/executive-mentor/references/hard_things.md))
...
### Firing a Co-Founder
See [`references/hard_things.md — Co-Founder Conflicts`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/executive-mentor/skills/executive-mentor/references/hard_things.md — Co-Founder Conflicts) for full framework.
