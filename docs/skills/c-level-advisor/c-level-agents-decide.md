...
<span class="meta-badge">:material-github: <a href="https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/c-level-agents/skills/decide/SKILL.md">Source</a></span>
</div>
...
- Bridge: [[`references/llm-wiki-bridge.md`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/c-level-agents/references/llm-wiki-bridge.md)](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/c-level-agents/references/llm-wiki-bridge.md)
