---
title: "Модели терраформирования { #terraform-patterns } — Агентский скилл для Codex и OpenClaw"
description: "Скилл агента Terraform infrastructure-as-code и плагин для Claude Code, Codex, Gemini CLI, Cursor, OpenClaw. Охватывает шаблоны проектирования."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering/terraform-patterns/skills/terraform-patterns/SKILL.md">Источник</a></span>
</div>
...
2. **Аудит государственной безопасности**
   ...
   | Отсутствие блокировки состояния | Высокий | Включите DynamoDB для S3, встроенную в TF Cloud |
...
- **Отсутствует `prevent_destroy` в базах данных/storage** → Добавить блок жизненного цикла для предотвращения случайного удаления.
...
### Когда использовать мульти-облако { #when-to-use-multi-cloud }
...
- Ранняя переменная/locals оценка
