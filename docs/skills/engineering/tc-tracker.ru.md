...
Отслеживайте каждое изменение кода со структурированными записями JSON, принудительным автоматом состояний и форматом хэндоффа сеанса, который позволяет новому сеансу искусственного интеллекта возобновить работу без сбоев по истечении срока действия предыдущего.
...
> Видишь [список литературы/хэндофф-format.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/tc-tracker/references/handoff-format.md) ознакомьтесь с полной структурой и правилами заполнения.
...
| Позволяя `next_steps` становятся несвежими | Противоречит цели хэндоффа | Обновляйте информацию о каждом этапе, даже если "ничего не изменилось". |
...
- [список литературы/хэндофф-format.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/tc-tracker/references/handoff-format.md) — Структура хэндоффа сессии и лучшие практики.
