...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/git-worktree-manager/SKILL.md">Source</a></span>
</div>
...
See [docker-compose-patterns.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/git-worktree-manager/references/docker-compose-patterns.md) for concrete templates.
...
See [port-allocation-strategy.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/git-worktree-manager/references/port-allocation-strategy.md) for the full strategy and edge cases.
...
- [README.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/git-worktree-manager/README.md) for quick start and installation details
