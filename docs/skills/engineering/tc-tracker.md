...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/tc-tracker/SKILL.md">Source</a></span>
</div>
...
> See [references/lifecycle.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/tc-tracker/references/lifecycle.md) for the full transition table and recovery flows.
...
> See [references/tc-schema.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/tc-tracker/references/tc-schema.md) for the full schema.
...
> See [references/handoff-format.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/tc-tracker/references/handoff-format.md) for the full structure and fill-out rules.
...
- [references/tc-schema.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/tc-tracker/references/tc-schema.md) — Full JSON schema for TC records and the registry.
- [references/lifecycle.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/tc-tracker/references/lifecycle.md) — State machine, valid transitions, and recovery flows.
- [references/handoff-format.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/tc-tracker/references/handoff-format.md) — Session handoff structure and best practices.
