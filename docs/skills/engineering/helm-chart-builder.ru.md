---
title: "Построение рулевой диаграммы { #helm-chart-builder } — Агентский скилл для Codex и OpenClaw"
description: "Агент по скиллу разработки Helm chart и плагин для Claude Code, Codex, Gemini CLI, Cursor, OpenClaw — построение диаграмм, проектирование значений."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering/helm-chart-builder/skills/helm-chart-builder/SKILL.md">Источник</a></span>
</div>
...
2. **Проверьте качество шаблона**
   ...
   | Нет запросов на ресурсы/limits | Критический | Добавьте раздел ресурсов со значениями по умолчанию.ямл |
   ...
   | Недостающая живость/readiness зонды | Высокий | Добавьте зонды с настраиваемыми путями и портами |
...
- **Нет запросов на ресурсы/limits** → Добавьте их. Модули без ограничений могут привести к истощению узла.
...
- **Отсутствие живости/readiness зонды** → Добавьте их. Kubernetes должен знать, исправен ли модуль.
