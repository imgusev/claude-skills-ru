...
| Генератор списка изменений | `changelog-generator/` | Списки изменений, семантические сбои в версиях, дисциплина исправления/отката |
| Инженерия хаоса | `chaos-engineering/` | Схема эксперимента, радиус взрыва, вскрытие |
...
| Сфокусированное исправление | `focused-fix/` | Систематический ремонт функций/модулей |
...
Примечание: управление выпусками объединено в `changelog-generator/` (теперь там действуют процедуры обновления версии + исправления/отката).
