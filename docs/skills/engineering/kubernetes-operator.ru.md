---
title: "Оператор Kubernetes { #kubernetes-operator } — Агентский скилл для Codex и OpenClaw"
description: "Используйте при создании оператора Kubernetes — пользовательские контроллеры, которые согласовывают состояние CRD. Триггеры для 'построения. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering/skills/kubernetes-operator/SKILL.md">Источник</a></span>
</div>
...
1. ** Идемпотент.** Согласование одного и того же состояния дважды → тот же результат, ноль побочных эффектов.
