---
title: "Эксперт по GDPR/DSGVO { #gdprdsgvo-expert } — Агентский скилл для комплаенса"
description: "Автоматизация соблюдения требований GDPR и немецкого DSGVO. Сканирует кодовые базы на предмет рисков для конфиденциальности, формирует документацию. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/ra-qm-team/skills/gdpr-dsgvo-expert/SKILL.md">Источник</a></span>
</div>
