---
title: "Специалист-консультант FDA { #fda-consultant-specialist } — Агентский скилл для комплаенса"
description: "Консультант по регулированию FDA для компаний, производящих медицинское оборудование. Содержит руководство по пути 510 (k)/PMA/ De Novo, QMSR (21 CFR. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/ra-qm-team/skills/fda-consultant-specialist/SKILL.md">Источник</a></span>
</div>
...
| 510(k) Сокращенный | Руководство/standard соответствие | 30 дней | 21 760 долларов США (2024 финансовый год) |
...
**Ссылка:** Смотрите [fda_submission_guide.md](https://github.com/imgusev/claude-skills-ru/tree/main/ra-qm-team/skills/fda-consultant-specialist/references/fda_submission_guide.md) для матриц принятия решений о путях и требований к представлению.
...
3. **План**: Определение корректирующих мер/preventive действия
...
**Ссылка:** Смотрите [qsr_compliance_requirements.md](https://github.com/imgusev/claude-skills-ru/tree/main/ra-qm-team/skills/fda-consultant-specialist/references/qsr_compliance_requirements.md) для исторической структуры QSR с полным сопоставлением положений QMSR/ISO 13485:2016.
...
**Ссылка:** Смотрите [hipaa_compliance_framework.md](https://github.com/imgusev/claude-skills-ru/tree/main/ra-qm-team/skills/fda-consultant-specialist/references/hipaa_compliance_framework.md) для чек-листов внедрения и шаблонов BAA.
...
**Ссылка:** Смотрите [device_cybersecurity_guidance.md](https://github.com/imgusev/claude-skills-ru/tree/main/ra-qm-team/skills/fda-consultant-specialist/references/device_cybersecurity_guidance.md) для получения примеров формата SBOM и шаблонов моделирования угроз.
