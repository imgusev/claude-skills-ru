---
title: "Специалист по продуктовому стратегу { #product-strategist } — Агентский скилл для продуктовых команд"
description: "Инструментарий стратегического руководства продуктом для руководителя отдела продуктов, охватывающий каскадную генерацию OKR, ежеквартальное. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/product-team/skills/product-strategist/SKILL.md">Источник</a></span>
</div>
