...
| ОКР, каскад стратегий, согласование целей | продукт-стратег | `skills/product-strategist/` |
...
| Анализ конкурентов, характеристика/pricing матрица | конкурентный срыв | `skills/competitive-teardown/` |
