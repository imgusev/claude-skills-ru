---
title: "Составитель контрактов и предложений { #contract--proposal-writer } — Агентский скилл для роста"
description: "Создавайте профессиональные деловые документы, ориентированные на юрисдикцию: внештатные контракты, проектные предложения, SOW, NDA и MSA. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/business-growth/skills/contract-and-proposal-writer/SKILL.md">Источник</a></span>
</div>
...
- Проектные предложения с указанием сроков/budget поломка
...
- Неконкурентоспособность: подлежит исполнению в разумных пределах/time
...
- Для NDA: всегда указывайте возвращаемый/destruction конфиденциальных материалов при расторжении
