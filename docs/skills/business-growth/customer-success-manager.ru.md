---
title: "Менеджер по работе с клиентами { #customer-success-manager } — Агентский скилл для роста"
description: "Отслеживает состояние клиентов, прогнозирует риск оттока и определяет возможности расширения, используя взвешенные модели оценки успешности клиентов. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/business-growth/skills/customer-success-manager/SKILL.md">Источник</a></span>
</div>
