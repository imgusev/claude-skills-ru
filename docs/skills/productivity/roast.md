---
title: "Roast — 5-Angle Idea Panel → One Verdict — Agent Skill for Personal Productivity"
description: "Use when someone asks to roast an idea, pressure-test or stress-test an idea, validate a business idea, 'convene the panel', get a brutal second. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
