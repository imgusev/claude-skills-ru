---
title: "Облачный архитектор Azure { #azure-cloud-architect } — Агентский скилл и плагин Codex"
description: "Разрабатывайте архитектуры Azure для стартапов и предприятий. Используйте, когда вас попросят спроектировать инфраструктуру Azure, создать шаблоны. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/azure-cloud-architect/SKILL.md">Источник</a></span>
</div>
