...
> Видишь [ссылки/фреймворк-a11y-patterns.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/a11y-audit/skills/a11y-audit/references/framework-a11y-patterns.md) для получения полного каталога шаблонов исправлений.
...
> Видишь [ссылки/примеры по фреймворкам.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/a11y-audit/skills/a11y-audit/references/examples-by-framework.md) для Vue, Angular, Next.js , и стройные примеры.
