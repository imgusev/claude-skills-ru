---
title: "Инициализировать проект драматурга { #initialize-playwright-project } — Агентский скилл и плагин Codex"
description: "Set up Playwright in a project. Use when user says 'set up playwright', 'add e2e tests', 'configure playwright', 'testing setup', 'init playwright'. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/playwright-pro/skills/init/SKILL.md">Источник</a></span>
</div>
