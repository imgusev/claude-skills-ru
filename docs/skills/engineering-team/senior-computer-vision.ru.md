---
title: "Старший инженер по компьютерному зрению { #senior-computer-vision-engineer } — Агентский скилл и плагин Codex"
description: "Скиллы для разработки систем компьютерного зрения для обнаружения объектов, сегментации изображений и визуальных систем искусственного интеллекта. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/senior-computer-vision/SKILL.md">Источник</a></span>
</div>
...
|-------------|-------------------------|-----|
| В реальном времени (>30 кадров в секунду) | YOLOv8/v11, RT-DETR | Одноступенчатый, оптимизированный по скорости |
...
| YOLOv8s | 2,1мс | 44.9 Карта | Сбалансированная скорость/точность |
...
## Справочная документация { #reference-documentation }
→ Смотрите ссылки/reference-docs-and-команды.md для получения подробной информации
