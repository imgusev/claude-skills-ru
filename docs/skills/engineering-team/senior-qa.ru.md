---
title: "Старший инженер по контролю качества { #senior-qa-engineer } — Агентский скилл и плагин Codex"
description: "Генерирует модульные тесты, интеграционные тесты и E2E-тесты для React/Next.js приложения. Сканирует компоненты для создания тестовых заготовок. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/senior-qa/SKILL.md">Источник</a></span>
</div>
...
Сканирование Next.js страницы/app каталог и генерирует тестовые файлы драматурга с общими взаимодействиями.
