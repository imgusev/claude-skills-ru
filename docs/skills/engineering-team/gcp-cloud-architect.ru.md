---
title: "Облачный архитектор GCP { #gcp-cloud-architect } — Агентский скилл и плагин Codex"
description: "Разрабатывайте архитектуры GCP для стартапов и предприятий. Используйте, когда вас попросят спроектировать облачную инфраструктуру Google, деплою в. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/gcp-cloud-architect/SKILL.md">Источник</a></span>
</div>
...
Используйте [Калькулятор цен на GCP](https://cloud.google.com/products/calculator) для получения подробных оценок.
...
### Веб-приложение в облаке (<100 долларов в месяц) { #web-app-on-cloud-run--100month }
...
### Микросервисы на GKE (500-2000 долларов в месяц) { #microservices-on-gke-500-2000month }
...
| Бюджет | Ежемесячный лимит GCP | максимум 500 долларов в месяц |
...
| Большой запрос по запросу для больших рабочих нагрузок | Непредсказуемые затраты в масштабах | Используйте слоты BigQuery (с фиксированной скоростью) для стабильных рабочих нагрузок |
