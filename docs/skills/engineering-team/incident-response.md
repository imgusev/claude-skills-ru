...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/incident-response/SKILL.md">Source</a></span>
</div>
...
| Skill | Relationship |
|-------|-------------|
| [threat-detection](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/threat-detection/SKILL.md) | Confirmed hunting findings escalate to incident-response for triage and classification |
| [cloud-security](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/cloud-security/SKILL.md) | Cloud posture findings (IAM compromise, S3 exposure) may trigger incident classification |
| [red-team](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/red-team/SKILL.md) | Red team findings validate detection coverage; confirmed gaps become hunting hypotheses |
| [security-pen-testing](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/security-pen-testing/SKILL.md) | Pen test vulnerabilities exploited in the wild escalate to incident-response for active incident handling |
