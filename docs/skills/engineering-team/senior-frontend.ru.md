---
title: "Старший интерфейс { #senior-frontend } — Агентский скилл и плагин Codex"
description: "Скилл разработки интерфейса для React, Next.js , TypeScript и CSS-приложения Tailwind. Используйте при создании компонентов React, оптимизируя. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/senior-frontend/SKILL.md">Источник</a></span>
</div>
...
### Интерпретация балльной оценки пакета { #bundle-score-interpretation }
...
| @mui/материал | Большой | shadcn/ui или базовый пользовательский интерфейс |
...
2. **Целевое значение LCP в миллисекундах** — одно число, не "быстрое". Определяет бюджет пакета и выбор рендеринга.
...
| `vite-spa` | Приложение с авторизацией, настольное/ корпоративное основное | 2500 мс | 200 КБ init + 80 КБ / маршрут |
...
3. **Прямой вызов инструмента:** `python scripts/frontend_decision_engine.py ...` — детерминированный профиль совпадает, когда известны входные данные.
