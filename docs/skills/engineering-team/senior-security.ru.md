...
| Ревью враждебного/состязательного кода | [`skills/adversarial-reviewer`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/adversarial-reviewer) | ревью 3-персоны с БЛОКИРОВКОЙ/ПРОБЛЕМАМИ/ЧИСТЫМ вердиктом |
...
| Документ | Содержание |
|----------|---------|
| [список литературы/threat-modeling-guide.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/senior-security/references/threat-modeling-guide.md) | Методология STRIDE, деревья атак, оценка СТРАХА, создание DFD |
...
| [ссылки/криптография-реализация.md](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/senior-security/references/cryptography-implementation.md) | AES-GCM, Ed25519, хэширование паролей (Argon2id), управление ключами |
