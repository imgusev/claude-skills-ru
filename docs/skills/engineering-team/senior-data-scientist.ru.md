---
title: "Старший специалист по обработке данных { #senior-data-scientist } — Агентский скилл и плагин Codex"
description: "Скилл старшего специалиста по обработке данных мирового класса, специализирующегося на статистическом моделировании, разработке экспериментов. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/senior-data-scientist/SKILL.md">Источник</a></span>
</div>
