...
<span class="meta-badge">:material-github: <a href="https://github.com/<GH_USER>/<REPO>/tree/main/engineering-team/self-improving-agent/skills/self-improving-agent/SKILL.md">Source</a></span>
</div>
...
- [playwright-pro](https://github.com/<GH_USER>/<REPO>/tree/main/engineering-team/playwright-pro/) — sister plugin in this repo
