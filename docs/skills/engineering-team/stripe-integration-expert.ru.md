---
title: "Эксперт по интеграции Stripe { #stripe-integration-expert } — Агентский скилл и плагин Codex"
description: "Интеграция Stripe производственного уровня: подписки с пробными версиями и пропорциональной оплатой, единовременные платежи, выставление счетов на. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/stripe-integration-expert/SKILL.md">Источник</a></span>
</div>
...
- Реализация планов повышения/понижения рейтингов с пропорциональным распределением
