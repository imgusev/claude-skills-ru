---
title: "Старший архитектор { #senior-architect } — Агентский скилл и плагин Codex"
description: "Этот скилл следует использовать, когда пользователь просит 'спроектировать архитектуру системы', 'оценить микросервисы по сравнению с монолитом'. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/senior-architect/SKILL.md">Источник</a></span>
</div>
...
- Высокая пропускная способность записи (>10 тыс./sec) → Кассандра или СциллаДБ
...
| Высокое чтение/write разница в соотношении | CQRS |
...
1. У модуля существенно разные потребности в масштабировании
