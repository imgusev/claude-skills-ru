---
title: "/cs:ии-акт-готовность — Закон ЕС об ИИ, форсирующий вопросы { #csai-act-readiness--eu-ai-act-forcing-questions } — Плагин и агентский скилл для Claude Code"
description: "/cs: ai-act-готовность к действию <система> — EU AI Act 6 - принудительный допрос с применением вопросов. Использовать во время внедрения системы. Агентский скилл для Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---

# /cs:ии-акт-готовность — Закон ЕС об ИИ, форсирующий вопросы { #csai-act-readiness--eu-ai-act-forcing-questions }
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/compliance-os/skills/ai-act-readiness/SKILL.md">Источник</a></span>
</div>
...
- Агент: [`cs-ai-act-compliance`](https://github.com/imgusev/claude-skills-ru/tree/main/compliance-os/agents/cs-ai-act-compliance.md)
- Скилл: [`eu-ai-act-specialist`](https://github.com/imgusev/claude-skills-ru/tree/main/ra-qm-team/skills/eu-ai-act-specialist/SKILL.md)
