...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/referral-program/SKILL.md">Source</a></span>
</div>
...
See [references/measurement-framework.md](https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/referral-program/references/measurement-framework.md) for benchmarks by industry and optimization playbook.
...
See [references/program-mechanics.md](https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/referral-program/references/program-mechanics.md) for detailed program patterns and real-world examples.
