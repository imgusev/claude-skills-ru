...
<span class="meta-badge">:material-github: <a href="https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/analytics-tracking/SKILL.md">Source</a></span>
</div>
...
See [references/event-taxonomy-guide.md](https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/analytics-tracking/references/event-taxonomy-guide.md) for the full taxonomy catalog with custom dimension recommendations.
...
See [references/gtm-patterns.md](https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/analytics-tracking/references/gtm-patterns.md) for full configuration templates.
