...
<span class="meta-badge">:material-github: <a href="https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/marketing-psychology/SKILL.md">Source</a></span>
</div>
...
The full catalog lives in [references/mental-models-catalog.md](https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/marketing-psychology/references/mental-models-catalog.md). Load it when you need to look up specific models or browse the full list.
