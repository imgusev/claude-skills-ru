...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/ad-creative/SKILL.md">Source</a></span>
</div>
...
See [references/platform-specs.md](https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/ad-creative/references/platform-specs.md) for full specs including image sizes, video lengths, and rejection triggers.
...
See [references/creative-frameworks.md](https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/ad-creative/references/creative-frameworks.md) for the full framework catalog with examples by platform.
