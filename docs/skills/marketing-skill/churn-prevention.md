...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/churn-prevention/SKILL.md">Source</a></span>
</div>
...
See [references/cancel-flow-playbook.md](https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/churn-prevention/references/cancel-flow-playbook.md) for full decision trees and flow templates.
...
See [references/dunning-guide.md](https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/churn-prevention/references/dunning-guide.md) for full email sequences and retry configuration examples.
