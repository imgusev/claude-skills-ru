...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/pricing-strategy/SKILL.md">Source</a></span>
</div>
...
See [references/pricing-models.md](https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/pricing-strategy/references/pricing-models.md) for model deep dives and SaaS examples.
...
See [references/pricing-page-playbook.md](https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/pricing-strategy/references/pricing-page-playbook.md) for design specs and copy templates.
