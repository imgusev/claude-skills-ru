...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/ab-test-setup/SKILL.md">Source</a></span>
</div>
...
**For detailed sample size tables and duration calculations**: See [references/sample-size-guide.md](https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/ab-test-setup/references/sample-size-guide.md)
...
**For templates**: See [references/test-templates.md](https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/ab-test-setup/references/test-templates.md)
