...
<span class="meta-badge">:material-github: <a href="https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/competitor-alternatives/SKILL.md">Source</a></span>
</div>
...
**For detailed templates**: See [references/templates.md](https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/competitor-alternatives/references/templates.md)
...
**For data structure and examples**: See [references/content-architecture.md](https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/competitor-alternatives/references/content-architecture.md)
