...
<span class="meta-badge">:material-github: <a href="https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/seo-audit/SKILL.md">Source</a></span>
</div>
...
- [SEO Audit Reference](https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/seo-audit/references/seo-audit-reference.md): Full audit framework, scoring, and remediation patterns
- [Core Web Vitals Thresholds](https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/seo-audit/references/cwv-thresholds.md): LCP/INP/CLS targets and triage rules
- [E-E-A-T Framework](https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/seo-audit/references/eeat-framework.md): Experience, Expertise, Authoritativeness, Trustworthiness checklist
- [Schema Types](https://github.com/<GH_USER>/<REPO>/tree/main/marketing-skill/skills/seo-audit/references/schema-types.md): Structured data patterns by content type
