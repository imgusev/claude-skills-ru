---
title: "/google-workspace — слэш-команда для ИИ-агентов разработки"
description: "Операции с интерфейсом Google Workspace CLI: диагностика настроек, аудит безопасности, поиск рецептов и анализ выходных данных. Использование. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/commands/google-workspace.md">Источник</a></span>
</div>
