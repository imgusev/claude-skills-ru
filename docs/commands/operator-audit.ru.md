---
title: "/operator-audit — слэш-команда для ИИ-агентов разработки"
description: "Запустите полный аудит оператора Kubernetes (CRD + согласование + возможность) в текущем репозитории. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/commands/operator-audit.md">Источник</a></span>
</div>
...
4. Вывод отчета Markdown с помощью pass/fail за проверку и конкретные последующие шаги
