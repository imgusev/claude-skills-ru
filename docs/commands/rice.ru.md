---
title: "/rice — слэш-команда для ИИ-агентов разработки"
description: "В RICE предусмотрена расстановка приоритетов с помощью подсчета очков и планирования производственных мощностей. Использование: /rice расставляет. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/commands/rice.md">Источник</a></span>
</div>
