---
title: "/tdd — слэш-команда для ИИ-агентов разработки"
description: "Запустите красно-зеленый воркфлоу TDD-рефакторинга — сначала сгенерируйте неудачные тесты, переведите в зеленый цвет, затем проверьте пробелы в. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/commands/tdd.md">Источник</a></span>
</div>
