---
title: "/cs-frontend-review — слэш-команда для ИИ-агентов разработки"
description: "Ревью Frontend engineering — отвечает на 7 форсирующих вопросов Мэтта Покока (устройство, цель LCP, рендеринг, бюджет пакета, SEO vs auth, система. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/commands/cs-frontend-review.md">Источник</a></span>
</div>
