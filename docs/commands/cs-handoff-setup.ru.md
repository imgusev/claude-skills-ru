...
2. **Окно хранения** — 7 / 30 дни / вечность / руководство пользователя.
3. **Строгость редактирования** — строго / предупреждать / выключать.
4. **Контекст Git** — автоматическое включение ветки + последняя фиксация + количество грязных файлов? да/no.
