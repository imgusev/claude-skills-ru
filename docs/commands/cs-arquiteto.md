...
description: "/cs:arquiteto — Constrói uma empresa do zero como bundle OKF (árvore de .md com type + grafo de links). Conduz a entrevista de 12 fases, uma de cada. Slash command for Claude Code, Codex CLI, Gemini CLI."
---
