---
title: "/code-to-prd — слэш-команда для ИИ-агентов разработки"
description: "Перепроектируйте кодовую базу интерфейса в PRD. Использование: /code-to-prd [путь]. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/commands/code-to-prd.md">Источник</a></span>
</div>
