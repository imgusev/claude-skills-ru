---
title: "/cs-fullstack-review — слэш-команда для ИИ-агентов разработки"
description: "Ревью Fullstack engineering — проходит 7 форсирующих вопросов Мэтта Покока, выбирает профиль, разветвляется на мощных специалистов (рецензент. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/commands/cs-fullstack-review.md">Источник</a></span>
</div>
