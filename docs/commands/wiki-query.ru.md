---
title: "/wiki-query — слэш-команда для ИИ-агентов разработки"
description: "Запросите вики— раздел LLM - читает index.md сначала просматривает 3-10 релевантных страниц, синтезирует ответ со встроенными цитатами [[викилинка]]. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/commands/wiki-query.md">Источник</a></span>
</div>
