---
title: "/project-health — слэш-команда для ИИ-агентов разработки"
description: "Дашборд состояния портфеля и анализ матрицы рисков. Использование: /project-health <Дашборд|риск> [параметры]. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/commands/project-health.md">Источник</a></span>
</div>
