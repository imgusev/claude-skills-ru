---
title: "/financial-health — слэш-команда для ИИ-агентов разработки"
description: "Выполните анализ финансовых коэффициентов, оценку DCF, анализ отклонений бюджета и скользящие прогнозы. Использование: /financial-health. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/commands/financial-health.md">Источник</a></span>
</div>
