...
description: "Просканируйте интерфейсный проект на предмет нарушений доступности WCAG 2.2 и исправьте их. Использование: /a11y-аудит [путь]. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
