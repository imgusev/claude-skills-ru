---
title: "/wiki-init — слэш-команда для ИИ-агентов разработки"
description: "Загрузите свежее хранилище LLM Wiki с трехуровневой структурой, файлами схем и начальными шаблонами. Использование /wiki-init <путь> --тема '<тема>'. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/commands/wiki-init.md">Источник</a></span>
</div>
