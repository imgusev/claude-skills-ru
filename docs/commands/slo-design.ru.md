...
description: "Интерактивный мастер для создания SLO с предупреждениями о SLI, цели, бюджете ошибок и скорости выгорания. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
