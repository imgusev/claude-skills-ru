---
title: "/slo-design — слэш-команда для ИИ-агентов разработки"
description: "Интерактивный мастер для разработки SLO с предупреждениями о SLI, цели, бюджете ошибок и скорости выгорания. Слэш-команда для Claude Code, Codex CLI, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/commands/slo-design.md">Источник</a></span>
</div>
...
- Тип SLI с выражениями числителя/знаменателя
