---
title: "Руководитель проекта Агент { #project-manager-agent } — ИИ-агент для Claude Code и Codex"
description: "Агент менеджера проекта по планированию спринта, воркфлоу Jira/Confluence, церемониям Scrum и отчетности стейкхолдеров. Организует скиллы по. Агентский оркестратор для Claude Code, Codex, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/agents/project-management/cs-project-manager.md">Источник</a></span>
</div>
...
**Местоположение скилла:** [`skills/senior-pm`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm)
...
1. **Дашборд работоспособности проекта**
   ...
   - **Путь:** [`scripts/project_health_dashboard.py`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/scripts/project_health_dashboard.py)
...
2. **Анализатор матрицы рисков**
   ...
   - **Путь:** [`scripts/risk_matrix_analyzer.py`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/scripts/risk_matrix_analyzer.py)
...
3. **Планировщик ресурсного потенциала**
   ...
   - **Путь:** [`scripts/resource_capacity_planner.py`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/scripts/resource_capacity_planner.py)
...
- [`references/portfolio-prioritization-models.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/references/portfolio-prioritization-models.md) -- WSJF, Москва, Стоимость задержки, фреймворки для оценки портфолио
- [`references/risk-management-framework.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/references/risk-management-framework.md) -- Идентификация рисков, качественный/количественный анализ, стратегии реагирования
- [`references/portfolio-kpis.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/references/portfolio-kpis.md) -- Определения ключевых показателей эффективности, частота отслеживания, показатели отчетности руководителей

**Шаблоны:**

- [`assets/executive_report_template.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/assets/executive_report_template.md) -- Отчет о состоянии исполнительной власти с указанием RAG, рисков, необходимых решений
- [`assets/project_charter_template.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/assets/project_charter_template.md) -- Устав проекта с указанием сферы охвата, целей, ограничений, стейкхолдеров
- [`assets/raci_matrix_template.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/assets/raci_matrix_template.md) -- Матрица распределения ответственности для межфункциональных команд

### Мастер схватки { #scrum-master }

**Местоположение скилла:** [`skills/scrum-master`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master)
...
1. **Показатель здоровья в спринте**
   ...
   - **Путь:** [`scripts/sprint_health_scorer.py`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/scripts/sprint_health_scorer.py)
...
2. **Анализатор скорости**
   ...
   - **Путь:** [`scripts/velocity_analyzer.py`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/scripts/velocity_analyzer.py)
...
3. **Анализатор ретроспективы**
   ...
   - **Путь:** [`scripts/retrospective_analyzer.py`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/scripts/retrospective_analyzer.py)
...
- [`references/retro-formats.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/references/retro-formats.md) -- Форматы Start/Stop/Continue, 4Ls, Парусник, Mad/Sad/Glad, Морская звезда
- [`references/team-dynamics-framework.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/references/team-dynamics-framework.md) -- Этапы Такмана, психологическая безопасность, разрешение конфликтов
- [`references/velocity-forecasting-guide.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/references/velocity-forecasting-guide.md) -- Моделирование методом Монте-Карло, доверительные интервалы, планирование производственных мощностей

**Шаблоны:**

- [`assets/sprint_report_template.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/assets/sprint_report_template.md) -- Отчет о ревью спринта с указанием времени выгорания, скорости, демонстрационных заметок
- [`assets/team_health_check_template.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/assets/team_health_check_template.md) -- Проверка работоспособности команды в стиле Spotify в 8 измерениях

### Эксперт Jira { #jira-expert }

**Местоположение скилла:** [`skills/jira-expert`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/jira-expert)

**Базы знаний:**

- [`references/jql-examples.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/jira-expert/references/jql-examples.md) -- Шаблоны запросов JQL для обработки бэклога, отчетности по спринту, отслеживания SLA
- [`references/automation-examples.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/jira-expert/references/automation-examples.md) -- Шаблоны правил автоматизации Jira для распространенных воркфлоу
- [`references/AUTOMATION.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/jira-expert/references/AUTOMATION.md) -- Полное руководство по автоматизации с триггерами, условиями, действиями
- [`references/WORKFLOWS.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/jira-expert/references/WORKFLOWS.md) -- Шаблоны проектирования воркфлоу, правила перехода, валидаторы, постфункции

### Эксперт по слияниям { #confluence-expert }

**Местоположение скилла:** [`skills/confluence-expert`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/confluence-expert)

**Базы знаний:**

- [`references/templates.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/confluence-expert/references/templates.md) -- Шаблоны страниц для планов спринта, заметок о собраниях, журналов принятия решений, документов по архитектуре

### Администратор Atlassian { #atlassian-admin }

**Местоположение скилла:** [`skills/atlassian-admin`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/atlassian-admin)
...
**Местоположение скилла:** [`skills/atlassian-templates`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/atlassian-templates)
...
2. ** Журнал невыполненных запросов через JQL ** - Используйте шаблоны jira-expert JQL для отбора приоритетных кандидатов:
   - Ссылка: [`references/jql-examples.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/jira-expert/references/jql-examples.md)
...
4. **Выберите журнал невыполненных работ спринта** - Фиксируйте элементы в пределах возможностей:
   - Применить WSJF или выбор на основе приоритета (ссылка: [`references/portfolio-prioritization-models.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/references/portfolio-prioritization-models.md))
...
5. **Документировать план спринта** - Создать страницу плана спринта Confluence:
   - Используйте шаблон из [`references/templates.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/confluence-expert/references/templates.md)
...
6. **Настройка отслеживания спринта** - Настройка дашбордов и автоматизации:
   - Создать дашборд выгорания/burnup (ссылка: [`references/AUTOMATION.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/jira-expert/references/AUTOMATION.md))
...
5. **Подготовить исполнительный отчет** - Объединить выводы в отчет:
   - Используйте шаблон: [`assets/executive_report_template.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/assets/executive_report_template.md)
...
6. **Опубликовать в Confluence** - Создать страницу исполнительной дашборд:
   - Ссылайтесь на определения ключевых показателей эффективности из [`references/portfolio-kpis.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/references/portfolio-kpis.md)
...
2. **Выберите ретро формат ** - Выберите формат, основанный на потребностях команды:
   - Ссылка: [`references/retro-formats.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/references/retro-formats.md)
...
3. **Облегчить ретроспективу** - Запустить сеанс:
   ...
   - Динамика справочной команды от [`references/team-dynamics-framework.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/references/team-dynamics-framework.md)
...
6. **Документ в Confluence** - Публикация ретро-резюме:
   - Используйте шаблон отчета о спринте: [`assets/sprint_report_template.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/assets/sprint_report_template.md)
...
3. **Проектировать воркфлоу** - Создавать воркфлоу, соответствующие командному процессу:
   - Ссылка: [`references/WORKFLOWS.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/jira-expert/references/WORKFLOWS.md)
...
4. **Настройка автоматизации** - Настройка правил автоматизации, экономящих время:
   - Ссылка: [`references/AUTOMATION.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/jira-expert/references/AUTOMATION.md)
   - Примеры из: [`references/automation-examples.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/jira-expert/references/automation-examples.md)
...
5. **Настройка пространства слияния** - Создание базы знаний команды:
   - Ссылка: [`references/templates.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/confluence-expert/references/templates.md)
...
6. **Создавайте дашборды** - Повышайте видимость для команды и стейкхолдеров:
   ...
   - Используйте шаблоны JQL из [`references/jql-examples.md`](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/jira-expert/references/jql-examples.md)
...
- [cs-менеджер по продукту](https://github.com/imgusev/claude-skills-ru/tree/main/agents/product/cs-product-manager.md) -- Определение приоритетов продукта с помощью RICE, поиск клиентов, разработка PRD
- [cs-agile-владелец продукта](https://github.com/imgusev/claude-skills-ru/tree/main/agents/product/cs-agile-product-owner.md) -- Генерация пользовательских историй, управление бэклогом, критерии приемлемости (запланировано)
- cs-scrum-мастер - Проведение специальной церемонии Scrum и командный коучинг (планируется)

## Ссылки { #references }

- **Скилл старшего помощника премьер-министра:** [../../управление проектами/скиллы/senior-pm/СКИЛЛЫ.md](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/senior-pm/SKILL.md)
- **Скилл Scrum-мастера:** [../../управление проектами/скиллы/scrum-мастер/СКИЛЛ.md](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/SKILL.md)
- **Экспертный скилл Jira:** [../../управление проектами/скиллы/jira-эксперт/СКИЛЛЫ.md](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/jira-expert/SKILL.md)
- **Скилл эксперта по слиянию:** [../../управление проектами/скиллы/confluence-эксперт/СКИЛЛЫ.md](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/confluence-expert/SKILL.md)
- **Скилл администратора Atlassian:** [../../управление проектами/скиллы/atlassian-администратор/СКИЛЛЫ.md](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/atlassian-admin/SKILL.md)
- **Руководство по домену PM:** [../../управление проектами/CLAUDE.md](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/CLAUDE.md)
