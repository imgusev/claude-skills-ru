---
title: "Импульсный агент { #pulse-agent } — ИИ-агент для Claude Code и Codex"
description: "Недавнее исследование персоны из нескольких источников. Отвечает на 2-4 вводных вопроса по одному за раз (специфика темы, ракурс, временное окно. Агентский оркестратор для Claude Code, Codex, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/research/pulse/agents/cs-pulse.md">Источник</a></span>
</div>


## Голос { #voice }

**Начало: ** "Закройте тему. Я расспрошу вас о специфике, ракурсе, временном интервале и сфере охвата, прежде чем тратить бюджет на поиск — затем я запускаю Reddit + HN + Web параллельно с 1 вопросом/sec потолок на платформу."
...
**Завершение:** "Брифинг сохранен в `${RESEARCH_DIR}/pulse/<slug>-<date>.md`. Кроссплатформенные шаблоны: [N сигналов консенсуса, M противоречий, K болевых точек]. Хотите продолжить что-нибудь из этого?"
...
3. ** Этапы 1-3 параллельно** — Reddit (топ + новые), HN (истории Algolia + комментарии), Web (2-3 целевых запроса). 1 вопрос/sec для каждой платформы; последовательный внутри.
...
4. **1 вопрос/sec для каждой платформы.** Подтвердите ответ перед следующим вызовом.
...
**Местоположение скилла:** [`skills/pulse`](https://github.com/imgusev/claude-skills-ru/tree/main/research/pulse/skills/pulse)

### Инструменты Python (Stdlib) { #python-tools-stdlib }

1. ** Калькулятор временного окна**
   - Путь: [`scripts/time_window_calculator.py`](https://github.com/imgusev/claude-skills-ru/tree/main/research/pulse/skills/pulse/scripts/time_window_calculator.py)
...
2. **Отслеживание цитируемости**
   - Путь: [`scripts/citation_tracker.py`](https://github.com/imgusev/claude-skills-ru/tree/main/research/pulse/skills/pulse/scripts/citation_tracker.py)
...
3. **Генератор шаблонов тем**
   - Путь: [`scripts/topic_slug_generator.py`](https://github.com/imgusev/claude-skills-ru/tree/main/research/pulse/skills/pulse/scripts/topic_slug_generator.py)
...
- [`references/research_pack_conventions.md`](https://github.com/imgusev/claude-skills-ru/tree/main/research/pulse/skills/pulse/references/research_pack_conventions.md) — Канон правил честности агента (более 7 источников)
- [`references/cross_platform_synthesis.md`](https://github.com/imgusev/claude-skills-ru/tree/main/research/pulse/skills/pulse/references/cross_platform_synthesis.md) — консенсус/controversy/pain обнаружение на разных платформах (более 7 источников)
- [`references/parallel_execution_discipline.md`](https://github.com/imgusev/claude-skills-ru/tree/main/research/pulse/skills/pulse/references/parallel_execution_discipline.md) — 1 вопрос/sec обоснование + сигналы уровня плана (более 7 источников)
...
- Скилл: [../skills/pulse/SKILL.md](https://github.com/imgusev/claude-skills-ru/tree/main/research/pulse/skills/pulse/SKILL.md)
...
- Родственная команда: [`/cs:pulse`](https://github.com/imgusev/claude-skills-ru/tree/main/research/pulse/commands/cs-pulse.md)
