...
1. **Фреймворк для принятия исполнительных решений**
   ...
   - **Содержание:** Структурированный процесс принятия решений для go/no-go решения, основные направления, возможности слияний и поглощений, антикризисное реагирование
...
4. **График трансформации культуры**:
   ...
   - **Месяцы 2-3**: Коммуникация и запуск
...
- ** Удерживаемые таланты:** Выбытие руководителей <10% ежегодно, удержание ключевых талантов >90%
- **Руководящий состав: ** более 2 внутренних преемников определены и подготовлены для каждой роли
...
- **Документация по скиллам:** [../../c-level-advisor/skills/ceo-advisor/SKILL.md](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/ceo-advisor/SKILL.md)
- **Руководство по домену уровня C:** [../../c-level-advisor/CLAUDE.md](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/CLAUDE.md)
