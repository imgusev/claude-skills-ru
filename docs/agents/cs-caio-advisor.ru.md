...
description: "Требовательный к оценке советник главного специалиста по ИИ по вопросам принятия решений о сборке моделей и покупке, классификации рисков ИИ в. Агентский оркестратор для Claude Code, Codex, Gemini CLI."
---
...
- Скилл: [../../скиллы/руководитель отдела искусственного интеллекта-советник/СКИЛЛЫ.md](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/chief-ai-officer-advisor/SKILL.md)
