...
- **Основной скилл:** [../../команда разработчиков продукта/agile-владелец продукта/скиллы/agile-владелец продукта/СКИЛЛЫ.md](https://github.com/imgusev/claude-skills-ru/tree/main/product-team/agile-product-owner/skills/agile-product-owner/SKILL.md)
- **РИСОВЫЙ фреймворк:** [../../команда по продукту/скиллы/инструментарий менеджера по продукту/СКИЛЛЫ.md](https://github.com/imgusev/claude-skills-ru/tree/main/product-team/skills/product-manager-toolkit/SKILL.md)
...
- **Скилл мастера Scrum:** [../../управление проектами/скиллы/scrum-мастер/СКИЛЛ.md](https://github.com/imgusev/claude-skills-ru/tree/main/project-management/skills/scrum-master/SKILL.md)
