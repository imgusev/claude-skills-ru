...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering/write-a-skill/agents/cs-skill-author.md">Источник</a></span>
</div>
...
**Местоположение скилла:** [`skills/write-a-skill`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/write-a-skill/skills/write-a-skill)

### Инструменты Python (Stdlib) { #python-tools-stdlib }

1. **Средство проверки описания скилла**
   - Путь: [`scripts/skill_description_validator.py`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/write-a-skill/skills/write-a-skill/scripts/skill_description_validator.py)
...
2. **Валидатор структуры скилла**
   - Путь: [`scripts/skill_structure_validator.py`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/write-a-skill/skills/write-a-skill/scripts/skill_structure_validator.py)
...
- [`references/companion_tooling.md`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/write-a-skill/skills/write-a-skill/references/companion_tooling.md) — Каталог инструментов (компоненты этого слоя оболочки)
- [`references/progressive_disclosure_principles.md`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/write-a-skill/skills/write-a-skill/references/progressive_disclosure_principles.md) — Потолок в 100 строк + правило глубиной в один уровень с 8 авторитетными источниками
- [`references/description_design_patterns.md`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/write-a-skill/skills/write-a-skill/references/description_design_patterns.md) — Хорошие и плохие шаблоны описания с 8 авторитетными источниками
- [`references/quality_gates_for_skills.md`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/write-a-skill/skills/write-a-skill/references/quality_gates_for_skills.md) — 6 обязательных шаблонов интеграции гейтов + CI с 7 авторитетными источниками
...
- [cs-karpathy-программист](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/karpathy-coder/agents/karpathy-reviewer.md) — Гейт качества кода (complexity_checker, diff_surgeon)
- [cs-tdd-руководство](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/skills/tdd-guide) — Тестовая дисциплина для кода (не файлы с скиллами)
