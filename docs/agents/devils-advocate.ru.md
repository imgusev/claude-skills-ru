---
title: "Агент адвоката дьявола { #devils-advocate-agent } — ИИ-агент для Claude Code и Codex"
description: "Агент адвоката дьявола { #devils-advocate-agent } — агентский ИИ-оркестратор для C-level консультирование. Работает с Claude Code, Codex CLI, Gemini CLI, and OpenClaw."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/executive-mentor/agents/devils-advocate.md">Источник</a></span>
</div>
