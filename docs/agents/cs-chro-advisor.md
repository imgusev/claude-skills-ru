...
<span class="meta-badge">:material-github: <a href="https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/c-level-agents/agents/cs-chro-advisor.md">Source</a></span>
</div>
...
**Skill Location:** [`skills/chro-advisor`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/skills/chro-advisor)

### Python Tools

1. **Hiring Plan Modeler**
   - Path: [`scripts/hiring_plan_modeler.py`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/skills/chro-advisor/scripts/hiring_plan_modeler.py)
   - Headcount plan by quarter, ramp-adjusted productivity, hiring funnel sensitivity

2. **Comp Benchmarker**
   - Path: [`scripts/comp_benchmarker.py`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/skills/chro-advisor/scripts/comp_benchmarker.py)
   - Stage-and-geo comp bands, equity refresh design, total-rewards composition

### Knowledge Bases

- [`references/people_strategy.md`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/skills/chro-advisor/references/people_strategy.md) — sourcing channels, interview rubrics, scorecards, time-to-fill
- [`references/comp_frameworks.md`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/skills/chro-advisor/references/comp_frameworks.md) — band design, equity strategy, refresh policy
- [`references/org_design.md`](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/skills/chro-advisor/references/org_design.md) — IC + manager tracks, level expectations, promotion criteria
...
- [cs-ceo-advisor](https://github.com/<GH_USER>/<REPO>/tree/main/agents/c-level/cs-ceo-advisor.md) — exec team
- [cs-workspace-admin](https://github.com/<GH_USER>/<REPO>/tree/main/agents/engineering-team/cs-workspace-admin.md) — onboarding tooling

## References

- Skill: [../../skills/chro-advisor/SKILL.md](https://github.com/<GH_USER>/<REPO>/tree/main/c-level-advisor/skills/chro-advisor/SKILL.md)
