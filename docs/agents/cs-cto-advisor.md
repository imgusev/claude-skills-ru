...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/agents/c-level/cs-cto-advisor.md">Source</a></span>
</div>
...
**Skill Location:** [`skills/cto-advisor`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/cto-advisor)
...
1. **Tech Debt Analyzer**
   ...
   - **Path:** [`scripts/tech_debt_analyzer.py`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/cto-advisor/scripts/tech_debt_analyzer.py)
...
2. **Team Scaling Calculator**
   ...
   - **Path:** [`scripts/team_scaling_calculator.py`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/cto-advisor/scripts/team_scaling_calculator.py)
...
1. **Architecture Decision Records (ADR)**
   - **Location:** [`references/architecture_decision_records.md`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/cto-advisor/references/architecture_decision_records.md)
...
2. **Engineering Metrics**
   - **Location:** [`references/engineering_metrics.md`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/cto-advisor/references/engineering_metrics.md)
...
3. **Technology Evaluation Framework**
   - **Location:** [`references/technology_evaluation_framework.md`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/cto-advisor/references/technology_evaluation_framework.md)
...
- [cs-fullstack-engineer](https://github.com/imgusev/claude-skills-ru/tree/main/agents/engineering/cs-fullstack-engineer.md) - Fullstack development coordination (planned)

## References

- **Skill Documentation:** [../../c-level-advisor/skills/cto-advisor/SKILL.md](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/cto-advisor/SKILL.md)
