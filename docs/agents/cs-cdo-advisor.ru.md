---
title: "Главный специалист по обработке данных Советник Агент { #chief-data-officer-advisor-agent } — ИИ-агент для Claude Code и Codex"
description: "Ответственный за принятие решений главный специалист по обработке данных, консультант по вопросам обучения ИИ правам на данные, стратегии продуктов. Агентский оркестратор для Claude Code, Codex, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/agents/cs-cdo-advisor.md">Источник</a></span>
</div>
...
Отличается от `cs-cto-advisor` (архитектура), `cs-ciso-advisor` (безопасность/соответствие требованиям), `cs-cpo-advisor` (стратегия продукта), и `cs-general-counsel-advisor` (ревью контракта). Каждый из них пересекается с одним концерном CDO, но ни один из них не владеет картиной стратегических данных.
...
**Местоположение скилла:** [`skills/chief-data-officer-advisor`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/chief-data-officer-advisor)

### Инструменты Python { #python-tools }

1. **Аудит данных обучения ИИ**
   - Путь: [`scripts/ai_training_data_audit.py`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/chief-data-officer-advisor/scripts/ai_training_data_audit.py)
   - Использование: `python ../../skills/chief-data-officer-advisor/scripts/ai_training_data_audit.py sources.json`
   - Аудит источников данных по 3-м измерениям (происхождение × класс × вариант использования), возвращает данные о разрешении/СМЯГЧЕНИИ ПОСЛЕДСТВИЙ /ЗАПРЕТЕ для каждого источника с указанием рисков + исправлений + ссылок на GDPR / AI Act

2. **Средство выбора стратегии продукта данных**
   - Путь: [`scripts/data_product_strategy_picker.py`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/chief-data-officer-advisor/scripts/data_product_strategy_picker.py)
   - Использование: `python ../../skills/chief-data-officer-advisor/scripts/data_product_strategy_picker.py profile.json`
   - Выбирает склад / лейкхаус / сетку + сравнение сборки и покупки для каждого слоя + дорожная карта последовательности действий на 12 месяцев. Детерминированный, производный от профиля.

3. **Оценщик активов данных**
   - Путь: [`scripts/data_asset_valuator.py`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/chief-data-officer-advisor/scripts/data_asset_valuator.py)
...
- [`references/ai_training_data_rights.md`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/chief-data-officer-advisor/references/ai_training_data_rights.md) — Матрица прав на обучение + статья 6 GDPR + Закон ЕС об искусственном интеллекте + Лоскутное одеяло штата США
- [`references/data_product_strategy.md`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/chief-data-officer-advisor/references/data_product_strategy.md) — Критерии уничтожения архитектуры + дерево решений о сборке или покупке + шаблон последовательности
- [`references/customer_data_as_asset.md`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/chief-data-officer-advisor/references/customer_data_as_asset.md) — Фреймворк оценки + 3 пути внедрения продукта + чек-лист для подготовки к слияниям и поглощениям + аудит договорных ограничений
- [`references/data_team_org_evolution.md`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/chief-data-officer-advisor/references/data_team_org_evolution.md) — Карта от этапа к роли + централизация против встраивания триггера + анти-паттерны
...
**Цель:** Оценить совокупность данных и подготовиться к проведению due diligence.
...
1. Перечислите топ-5 решений, которые бизнес не может принять сегодня из-за отсутствия данных/анализа
2. Соотнесите каждое решение с ролью, которая его реализует (см. ../../скиллы/руководитель отдела обработки данных-советник/ссылки/data_team_org_evolution.md)
...
- ** Ноль не предусмотренных бюджетом регулятивных нарушений: ** Закон об искусственном интеллекте / GDPR / законы штатов - все это сопоставлено с дорожной картой продукта

## Связанные агенты { #related-agents }

- [cs-технический директор-консультант](https://github.com/imgusev/claude-skills-ru/tree/main/agents/c-level/cs-cto-advisor.md) — архитектурный потенциал
...
- Скилл: [../../скиллы/руководитель отдела обработки данных-советник/СКИЛЛЫ.md](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/skills/chief-data-officer-advisor/SKILL.md)
...
- Родственная команда: [`/cs:cdo-review`](https://github.com/imgusev/claude-skills-ru/tree/main/c-level-advisor/c-level-agents/skills/cdo-review/SKILL.md)
