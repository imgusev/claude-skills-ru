---
title: "cs-рабочее пространство-администратор { #cs-workspace-admin } — ИИ-агент для Claude Code и Codex"
description: "Агент администрирования Google Workspace, использующий gws CLI. Организует настройку рабочего пространства, автоматизацию Gmail / диска / таблиц /. Агентский оркестратор для Claude Code, Codex, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/agents/engineering-team/cs-workspace-admin.md">Источник</a></span>
</div>
...
[`engineering-team/google-workspace-cli`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/google-workspace-cli)

### Инструменты Python { #python-tools }

1. **Врач GWS**
   - **Путь:** [`scripts/gws_doctor.py`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/google-workspace-cli/skills/google-workspace-cli/scripts/gws_doctor.py)
...
2. **Руководство по настройке авторизации**
   - **Путь:** [`scripts/auth_setup_guide.py`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/google-workspace-cli/skills/google-workspace-cli/scripts/auth_setup_guide.py)
...
3. ** Бегунок для приготовления рецепта**
   - **Путь:** [`scripts/gws_recipe_runner.py`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/google-workspace-cli/skills/google-workspace-cli/scripts/gws_recipe_runner.py)
...
4. ** Аудит рабочего пространства**
   - **Путь:** [`scripts/workspace_audit.py`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/google-workspace-cli/skills/google-workspace-cli/scripts/workspace_audit.py)
...
5. **Анализатор выходных данных**
   - **Путь:** [`scripts/output_analyzer.py`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/google-workspace-cli/skills/google-workspace-cli/scripts/output_analyzer.py)
...
1. **Ссылка на команду** — [`references/gws-command-reference.md`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/google-workspace-cli/skills/google-workspace-cli/references/gws-command-reference.md)
   - 18 служб, 22 помощника, глобальные флаги, переменные окружения
2. ** Кулинарная книга рецептов** — [`references/recipes-cookbook.md`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/google-workspace-cli/skills/google-workspace-cli/references/recipes-cookbook.md)
   - 43 рецепта, упорядоченных по категориям с отображением персон
3. **Устранение неполадок** — [`references/troubleshooting.md`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/google-workspace-cli/skills/google-workspace-cli/references/troubleshooting.md)
   - Распространенные ошибки, проблемы с авторизацией, исправления для конкретной платформы

### Шаблоны { #templates }

1. **Конфигурация рабочей области** — [`assets/workspace-config.json`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/google-workspace-cli/skills/google-workspace-cli/assets/workspace-config.json)
   - Шаблон конфигурации автоматизации с авторизацией, значениями по умолчанию, запланированными задачами
2. **Профили персон** — [`assets/persona-profiles.md`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/google-workspace-cli/skills/google-workspace-cli/assets/persona-profiles.md)
...
- [cs-старший инженер](https://github.com/imgusev/claude-skills-ru/tree/main/agents/engineering/cs-senior-engineer.md) — Архитектура и CI/CD

## Ссылки { #references }

- [Документация по скиллам](https://github.com/imgusev/claude-skills-ru/tree/main/engineering-team/google-workspace-cli/skills/google-workspace-cli/SKILL.md)
