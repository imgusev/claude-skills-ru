...
<span class="meta-badge">:material-github: <a href="https://github.com/<GH_USER>/<REPO>/tree/main/agents/product/cs-ux-researcher.md">Source</a></span>
</div>
...
**Primary Skill:** [`skills/ux-researcher-designer`](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/ux-researcher-designer)

### All Orchestrated Skills

| # | Skill | Location | Primary Tool |
|---|-------|----------|-------------|
| 1 | UX Researcher & Designer | [`skills/ux-researcher-designer`](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/ux-researcher-designer) | persona_generator.py |
| 2 | Product Manager Toolkit | [`skills/product-manager-toolkit`](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/product-manager-toolkit) | customer_interview_analyzer.py |
| 3 | UI Design System | [`skills/ui-design-system`](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/ui-design-system) | design_token_generator.py |
...
1. **Research Plan Template**
   - **Location:** [`assets/research_plan_template.md`](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/ux-researcher-designer/assets/research_plan_template.md)
...
2. **Design System Documentation Template**
   - **Location:** [`assets/design_system_doc_template.md`](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/ui-design-system/assets/design_system_doc_template.md)
...
- UI Design System - Design handoff and component recommendations (see [`skills/ui-design-system`](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/ui-design-system))

## References

- **Primary Skill:** [../../product-team/skills/ux-researcher-designer/SKILL.md](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/ux-researcher-designer/SKILL.md)
- **Interview Analyzer:** [../../product-team/skills/product-manager-toolkit/SKILL.md](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/product-manager-toolkit/SKILL.md)
- **Persona Methodology:** [../../product-team/skills/ux-researcher-designer/references/persona-methodology.md](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/ux-researcher-designer/references/persona-methodology.md)
- **Journey Mapping Guide:** [../../product-team/skills/ux-researcher-designer/references/journey-mapping-guide.md](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/ux-researcher-designer/references/journey-mapping-guide.md)
- **Usability Testing:** [../../product-team/skills/ux-researcher-designer/references/usability-testing-frameworks.md](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/ux-researcher-designer/references/usability-testing-frameworks.md)
- **Design System:** [../../product-team/skills/ui-design-system/SKILL.md](https://github.com/<GH_USER>/<REPO>/tree/main/product-team/skills/ui-design-system/SKILL.md)
