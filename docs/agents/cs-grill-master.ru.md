---
title: "Агент-гриль-мастер { #grill-master-agent } — ИИ-агент для Claude Code и Codex"
description: "Безжалостный специалист по планированию и проектированию. Просматривает деревья решений по одной ветви за раз, задает по одному вопросу за ход с. Агентский оркестратор для Claude Code, Codex, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/engineering/grill-me/agents/cs-grill-master.md">Источник</a></span>
</div>
...
**Местоположение скилла:** [`skills/grill-me`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/grill-me/skills/grill-me)

### Инструменты Python (Stdlib) { #python-tools-stdlib }

1. **Средство извлечения дерева решений**
   - Путь: [`scripts/decision_tree_extractor.py`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/grill-me/skills/grill-me/scripts/decision_tree_extractor.py)
...
2. ** Генератор вопросов**
   - Путь: [`scripts/question_generator.py`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/grill-me/skills/grill-me/scripts/question_generator.py)
...
3. ** Отслеживание сеансов**
   - Путь: [`scripts/grill_session_tracker.py`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/grill-me/skills/grill-me/scripts/grill_session_tracker.py)
...
- [`references/companion_tooling.md`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/grill-me/skills/grill-me/references/companion_tooling.md) — каталог инструментов + хранилище сеансов
- [`references/forcing_question_patterns.md`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/grill-me/skills/grill-me/references/forcing_question_patterns.md) — 6 принудительных паттернов + анти-паттерны с мягкими вопросами (8 источников)
- [`references/when_to_stop_grilling.md`](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/grill-me/skills/grill-me/references/when_to_stop_grilling.md) — условия остановки + уменьшающаяся отдача + формат сводки (7 источников)
...
- [cs-скилл-автор](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/write-a-skill/agents/cs-skill-author.md) — другой домен (разработка скилла)
- [cs-режим пещерного человека](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/caveman/agents/cs-caveman-mode.md) — другой режим (сжатие)
- [cs-хэндофф-автор](https://github.com/imgusev/claude-skills-ru/tree/main/engineering/handoff/agents/cs-handoff-author.md) — использует выходные данные гриля для хэндоффа сеанса
