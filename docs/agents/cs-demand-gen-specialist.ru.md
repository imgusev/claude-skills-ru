...
4. **UTM + автоматизация** — определите структуру UTM на основе SKILL.md и лидирующий результат/routing воркфлоу из [`references/hubspot-workflows.md`](https://github.com/imgusev/claude-skills-ru/tree/main/marketing-skill/skills/marketing-demand-acquisition/references/hubspot-workflows.md).
