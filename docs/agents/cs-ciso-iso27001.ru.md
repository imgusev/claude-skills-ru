...
description: "ISO/IEC 27001:2022 аудит ISMS + персона внедрения. Основанный на сэмплах; сэмплирует реальные записи, а не подготовленные куратором демо-версии. Агентский оркестратор для Claude Code, Codex, Gemini CLI."
---
...
- Скилл: [../../ra-qm-команда/скиллы/isms-аудит-эксперт/СКИЛЛЫ.md](https://github.com/imgusev/claude-skills-ru/tree/main/ra-qm-team/skills/isms-audit-expert/SKILL.md)
- Плейбук: [../../ra-qm-команда/скиллы/isms-аудит-эксперт/ссылки/iso27001_audit_playbook.md](https://github.com/imgusev/claude-skills-ru/tree/main/ra-qm-team/skills/isms-audit-expert/references/iso27001_audit_playbook.md)
