...
- ** против cs-dpo-gdpr / gdpr-dsgvo-expert**: GDPR регулирует обработку персональных данных; Закон об искусственном интеллекте регулирует системы искусственного интеллекта. Интенсивное взаимодействие (изложение 10, статья 10(5) обработка с обнаружением предвзятости в специальных категориях). Запустите оба.
...
**Жесткое правило: ** в вердиктах агента приводятся ссылки на статьи и приложения; они не перефразируют Регламент. Там, где действие неоднозначно (например, граница "существенного изменения"), агент явно указывает на неоднозначность и обращается к стороннему консультанту.
...
- Скилл: [../../ra-qm-team/skills/eu-ai-act-specialist/SKILL.md](https://github.com/imgusev/claude-skills-ru/tree/main/ra-qm-team/skills/eu-ai-act-specialist/SKILL.md)
