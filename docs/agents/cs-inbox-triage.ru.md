---
title: "Агент по сортировке входящих сообщений { #inbox-triage-agent } — ИИ-агент для Claude Code и Codex"
description: "Повторяющаяся персона для выполнения сортировки по электронной почте. Считывает 7-килобайтный файл, созданный программой inbox-setup, классифицирует. Агентский оркестратор для Claude Code, Codex, Gemini CLI."
---
...
<span class="meta-badge">:material-github: <a href="https://github.com/imgusev/claude-skills-ru/tree/main/productivity/email/agents/cs-inbox-triage.md">Источник</a></span>
</div>
...
**Местоположение скилла:** [`skills/inbox-triage`](https://github.com/imgusev/claude-skills-ru/tree/main/productivity/email/skills/inbox-triage)

### Инструменты Python (Stdlib) { #python-tools-stdlib }

1. **Считыватель КБАЙТ**
   - Путь: [`scripts/kb_reader.py`](https://github.com/imgusev/claude-skills-ru/tree/main/productivity/email/skills/inbox-triage/scripts/kb_reader.py)
...
- [`references/kb_file_contract.md`](https://github.com/imgusev/claude-skills-ru/tree/main/productivity/email/skills/inbox-triage/references/kb_file_contract.md) — канонический контракт на 7 файлов (с точки зрения чтения; отражает версию на стороне установки)
- [`references/triage_decision_framework.md`](https://github.com/imgusev/claude-skills-ru/tree/main/productivity/email/skills/inbox-triage/references/triage_decision_framework.md) — ПРИМИТЕ ЭТО / СТОИТ РАССМОТРЕТЬ / ПЕРЕДАТЬ / ПОМЕТИТЬ ДЛЯ РЕВЬЮ таксономии
- [`references/drafts_only_safety.md`](https://github.com/imgusev/claude-skills-ru/tree/main/productivity/email/skills/inbox-triage/references/drafts_only_safety.md) — канон дисциплины "НИКОГДА НЕ ОТПРАВЛЯЙ"
...
- [cs-импульс](https://github.com/imgusev/claude-skills-ru/tree/main/research/pulse/agents/cs-pulse.md) — внешнее исследование (другая предметная область)
