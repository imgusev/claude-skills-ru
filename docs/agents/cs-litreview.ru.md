...
description: "Персона, ориентированная на академическую литературу. Выполняет 3 принудительных вводных вопроса (специфика исследовательского вопроса + подсказка. Агентский оркестратор для Claude Code, Codex, Gemini CLI."
---
...
- Скилл: [../скиллы/litreview/СКИЛЛЫ.md](https://github.com/imgusev/claude-skills-ru/tree/main/research/litreview/skills/litreview/SKILL.md)
