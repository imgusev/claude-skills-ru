...
| **конструктор баз данных** | Разработка схемы, миграция, индексация, оптимизация запросов. | Работа с базой данных |
...
** Также работает с: ** Кодом Claude · OpenAI Codex · Gemini CLI · OpenClaw · Aider · Виндсерфинг · Kilo Code · OpenCode · Дополнение · Антигравитация
