---
name: "gc-review"
description: "/cs:gc-ревью <план> — опрос главного юрисконсульта по контрактам, интеллектуальной собственности, нормативным актам, срокам службы и трудовому праву. Используйте при ревью технического задания перед подписанием, повторном включении в MSA клиента или проверке назначения IP и соответствия требованиям нормативных актов для нового продукта."
---
...
Начиная с версии 2.5.1, эта команда поддерживается полным скилл в `../../../skills/general-counsel-advisor/` с помощью двух инструментов Python:
...
- Скилл: [`general-counsel-advisor`](../../../skills/general-counsel-advisor/SKILL.md) — полный скилл работы с инструментами Python + ссылки
- Агент: [`cs-general-counsel-advisor`](../../agents/cs-general-counsel-advisor.md)
- Выполнение требований законодательства: `../../../../ra-qm-team/`
- Смежный: `../../../skills/ma-playbook/`
