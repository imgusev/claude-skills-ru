---
name: "boardroom"
description: "/cs: зал заседаний <краткое описание> — 6-фазное многоцелевое обсуждение в C-suite с выделением фазы 2, предварительным просмотром критики и обобщением. Выводит памятку на доске объявлений. Используйте, когда решение охватывает несколько областей управления — например, изменение цен, касающееся финансов, позиционирования и продукта, или решение о повышении или сокращении взлетно-посадочной полосы."
---
