---
name: "c-level-agents"
description: "Команда руководителей в режиме основателя. 13 агентов cs-* C-suite (финансовый директор, CMO, CRO, CPO, исполнительный директор, CHRO, CISO, генеральный директор, CDO, CAIO, CCO, вице-президент, начальник штаба) и 21 /cs:* слэш-команды для форсирования рабочего времени, обсуждения в зале заседаний с несколькими ролями, стратегического спринта. пайплайн и мета-маршрутизация. Используйте, когда основателю нужна виртуальная исполнительная команда, при вызове команд /cs:* или при принятии многоцелевых решений."
license: MIT
metadata:
  version: 1.0.0
...
Видишь `../../references/persona-voices.md` для голосовых характеристик.
...
- **llm-wiki** — дополнительный мост постоянной памяти (см. `../../references/llm-wiki-bridge.md`)
...
- [Родительский уровень c CLAUDE.md](../../../CLAUDE.md)
- [Существующий брат-руководитель-наставник](../../../executive-mentor/)
