---
name: "caio-review"
description: "/cs:caio-ревью <плана> — Оценка - требовательный опрос главного специалиста по ИИ любого плана, который включает ИИ: выбор модели, классификацию рисков, экономию затрат или наем ИИ. Используйте при отправке функции искусственного интеллекта без набора eval, выборе между API, точной настройкой и самостоятельным размещением или классификации варианта использования в соответствии с Законом ЕС об искусственном интеллекте."
---
...
- Агент: [`cs-caio-advisor`](../../agents/cs-caio-advisor.md)
- Скилл: [`chief-ai-officer-advisor`](../../../skills/chief-ai-officer-advisor/SKILL.md)
- Смежный: `../../../skills/chief-data-officer-advisor/` (обучение правам на данные, стратегия обработки данных)
