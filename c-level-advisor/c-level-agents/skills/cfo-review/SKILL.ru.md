---
name: "cfo-review"
description: "/cs: финансовый директор - ревью <плана> — Подсчитать - скептическое отношение к любому плану, который касается денег. Экономика предприятия, взлетно-посадочная полоса, разбавление, распределение капитала. Используйте, когда план предусматривает значительные расходы — например, волну найма, решение о сборе средств или бюджет нового канала."
---
...
- Агент: [`cs-cfo-advisor`](../../agents/cs-cfo-advisor.md)
- Скилл: [`cfo-advisor`](../../../skills/cfo-advisor/SKILL.md)
