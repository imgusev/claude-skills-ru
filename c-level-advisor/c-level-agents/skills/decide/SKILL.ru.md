---
name: "decide"
description: "/cs:decide <memo> — Заносит решение в двухуровневую память с помощью регистратора решений. Утвержденная памятка становится долговечной; необработанные стенограммы сохраняются для справки. Используйте, когда основатель одобрил памятку для совета директоров и решение должно надолго остаться в памяти компании — например, сразу после завершения /cs:boardroom."
---

# /cs:decide — Зарегистрируйте решение { #csdecide--log-the-decision }
...
Самый большой риск при принятии одобренных решений - это забыть, почему кто-то не согласился. Когда срабатывает триггер "критерии уничтожения", несогласие часто оказывается правильным. Сохранение этого дословно, а не в кратком изложении, позволяет компании оставаться честной во время вскрытия.
...
- Мост: [`../../references/llm-wiki-bridge.md`](../../references/llm-wiki-bridge.md)
