---
name: "onboard"
description: "/cs:онбординг — интервью с основателем, которое заполняет ~/.claude/company-context.md, используя каноническую 7-мерную схему cs-онбординг. Первая команда, выполняемая при запуске с агентами уровня c. Используйте при настройке виртуального C-suite для новой компании или когда консультантам не хватает контекста компании — например, перед первым заседанием /cs:boardroom или после того, как сбор средств изменит цифры."
---
...
- **Хранилище Markdown (рекомендуется):** смотрите [`../../references/llm-wiki-bridge.md`](../../references/llm-wiki-bridge.md)
...
- Скилл: [`cs-onboard`](../../../skills/cs-onboard/SKILL.md) — основной протокол собеседования
- Скилл: [`context-engine`](../../../skills/context-engine/SKILL.md) — считывает этот файл
- Ссылка: [`../../references/llm-wiki-bridge.md`](../../references/llm-wiki-bridge.md)
