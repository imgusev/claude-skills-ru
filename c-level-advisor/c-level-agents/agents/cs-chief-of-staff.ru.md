...
description: "Руководитель отдела маршрутизации и синтеза, отвечающий за организацию виртуального зала заседаний, протоколирование решений и выявление устаревших"
...
**Местоположение скилла:** `../../skills/chief-of-staff/`

### Базы знаний { #knowledge-bases }

- `../../skills/chief-of-staff/references/routing-matrix.md` — ключевые слова → сопоставление ролей, многоцелевые триггеры
- `../../skills/chief-of-staff/references/synthesis-framework.md` — как объединить входные данные от нескольких советников

### Координационные скиллы { #coordination-skills }

- `../../skills/board-meeting/` — 6-фазный протокол обсуждения с изоляцией фазы 2
- `../../skills/decision-logger/` — двухуровневая память (необработанные стенограммы + утвержденные решения)
- `../../skills/context-engine/` — загрузка контекста компании + анонимизация
- `../../skills/agent-protocol/` — вызов между агентами, предотвращение цикла, цикл контроля качества
...
- [cs-генеральный директор-советник](../../../agents/c-level/cs-ceo-advisor.md) — первичный восходящий отчет
- [руководитель-наставник / адвокат дьяволов](../../executive-mentor/agents/devils-advocate.md) — состязательная проверка перед принятием решения
