...
- `../../skills/chro-advisor/references/people_strategy.md` — каналы поиска, рубрики интервью, оценочные карточки, время на заполнение
- `../../skills/chro-advisor/references/comp_frameworks.md` — дизайн полосы, стратегия акционерного капитала, политика обновления
- `../../skills/chro-advisor/references/org_design.md` — Отслеживание менеджера IC +, ожидания от уровня, критерии продвижения по службе
...
- [cs-генеральный директор-советник](../../../agents/c-level/cs-ceo-advisor.md) — исполнительная команда
- [cs-рабочее пространство-администратор](../../../agents/engineering-team/cs-workspace-admin.md) — инструмент для онбординга
