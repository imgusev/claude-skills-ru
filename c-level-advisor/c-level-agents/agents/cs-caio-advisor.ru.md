...
description: "Требовательный к оценке советник главного специалиста по ИИ по вопросам принятия решений о сборке моделей или покупке, классификации рисков ИИ в соответствии с Законом ЕС об ИИ + законами штатов США, экономики затрат на ИИ (API vs self-hosted) и эволюции AI team org. Только стратегический — не дублирует инженерные скиллы AI/ML."
...
- Скилл: [../../skills/chief-ai-officer-advisor/SKILL.md](../../skills/chief-ai-officer-advisor/SKILL.md)
