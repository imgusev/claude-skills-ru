...
description: "/cs: iso27001-аудит-подготовка <область применения> — готовность к аудиту ISMS по стандарту ISO 27001 6- принудительный опрос. Используйте перед ежегодным разделом 9.2 внутреннего аудита, подготовкой к надзорному аудиту или сертификационной готовности 1-го этапа."
---

# /cs: iso27001-аудит-подготовка — аудит ISMS ISO 27001 Форсирует вопросы { #csiso27001-audit-prep--iso-27001-isms-audit-forcing-questions }
...
- Каждый пункт 4-10 + каждый применимый элемент управления приложения А должен подвергаться аудиту не реже одного раза в трехлетний цикл
...
- Каждый высокий/критический риск должен быть связан с контролем, относящимся к ≥ 1 приложению А, рассматривающему его
...
- Агент: [`cs-ciso-iso27001`](../../agents/cs-ciso-iso27001.md)
- Скилл: [`isms-audit-expert`](../../../ra-qm-team/skills/isms-audit-expert/SKILL.md)
- Плейбук: [iso27001_audit_playbook.md](../../../ra-qm-team/skills/isms-audit-expert/references/iso27001_audit_playbook.md)
- Смежный: `../soc2-audit-prep/`, `../aims-audit/`, `../gdpr-audit-prep/`, `../compliance-readiness/`
