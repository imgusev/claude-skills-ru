...
description: "Специалист по соблюдению требований в рамках нескольких фреймворков, организующий программы в рамках нескольких фреймворков. Направляет углубленную работу по фреймворку к скиллам специалистов (ISO 42001, EU AI Act, ISO 27001, SOC 2, GDPR, ISO 13485 и т.д.). Владеет выбором фреймворка, перекрестным дублированием фреймворков, календарем аудита, единым пулом доказательств. НЕ глубокое погружение в каждый фреймворк (те, кто живет в скиллах специалистов ra-qm-team)."
...
**Местоположение скилла:** `../skills/compliance-os/`

### Инструменты Python { #python-tools }

1. **Селектор фреймворков**
   - Путь: `../skills/compliance-os/scripts/framework_selector.py`
...
2. **Кросс-фреймворк-картограф**
   - Путь: `../skills/compliance-os/scripts/cross_framework_mapper.py`
...
3. **Симулятор аудита**
   - Путь: `../skills/compliance-os/scripts/audit_simulator.py`
...
4. **Генератор пула доказательств**
   - Путь: `../skills/compliance-os/scripts/evidence_pool_generator.py`
...
- `../skills/compliance-os/references/compliance_os_pattern.md` — Архитектура мета-фреймворка; когда организовывать vs запускать отдельно; шаблон интегрированной системы управления (IMS)
- `../skills/compliance-os/references/cross_framework_overlap.md` — 9-фреймворк × матрица перекрытия контрольного семейства с руководством по последовательности
- `../skills/compliance-os/references/audit_simulation_methodology.md` — ISO 19011 + IIA IPPF + AICPA AT-C аудит -принципы моделирования
- `../skills/compliance-os/references/evidence_management.md` — Разработка пула доказательств + рычаги повторного использования + сохранение + свежесть
...
- [cs-контроль качества-нормативный](../../agents/ra-qm-team/cs-quality-regulatory.md) — Оркестратор СМК / регулирования, ориентированный на медицинское оборудование (специалист по соблюдению требований более широк; регулирование качества глубоко связано с медицинским оборудованием)
- [cs-caio-советник](../../c-level-advisor/c-level-agents/agents/cs-caio-advisor.md) — Стратегия управления искусственным интеллектом (сборка против покупки, выбор модели)
- [cs-генеральный юрисконсульт-консультант](../../c-level-advisor/c-level-agents/agents/cs-general-counsel-advisor.md) — Юридическое воздействие (контракты, интеллектуальная собственность)
- [cs-ciso-советник](../../c-level-advisor/c-level-agents/agents/cs-ciso-advisor.md) — Стратегия исполнительной власти в области кибербезопасности

## Ссылки { #references }

- Скилл: [../скиллы/соответствие требованиям-os/СКИЛЛЫ.md](../skills/compliance-os/SKILL.md)
- Родственные команды: [`/cs:compliance-readiness`](../skills/compliance-readiness/SKILL.md), [`/cs:aims-audit`](../skills/aims-audit/SKILL.md), [`/cs:ai-act-readiness`](../skills/ai-act-readiness/SKILL.md)
