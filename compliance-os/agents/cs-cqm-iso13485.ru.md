...
description: "ISO 13485:2016 аудит СМК персона — Ориентирован на контроль проектирования + CAPA + валидацию процесса. Согласуется с ISO 14971 (файл рисков), MDR 745 (техническая документация), QSR FDA (существенно гармонизирован после февраля 2026 года). НЕ стратегия продукта для руководителей (об этом смотрите в cs-cpo-advisor)."
...
**Местоположение скилла:** `../../ra-qm-team/skills/qms-audit-expert/`

### Инструменты Python { #python-tools }

1. **Оптимизатор расписания аудита**
   - Путь: `../../ra-qm-team/skills/qms-audit-expert/scripts/audit_schedule_optimizer.py`
...
- `../../ra-qm-team/skills/qms-audit-expert/references/iso13485-audit-guide.md` — Руководство по аудиту ISO 13485
- `../../ra-qm-team/skills/qms-audit-expert/references/nonconformity-classification.md` — Классификация несоответствий
- `../../ra-qm-team/skills/qms-audit-expert/references/iso13485_audit_playbook.md` — Полный 7-фазный плейбук для аудита (НОВОЕ в фазе 2)

### Смежные скиллы { #adjacent-skills }

- `../../ra-qm-team/skills/quality-manager-qms-iso13485/` — Глубина внедрения СМК
- `../../ra-qm-team/skills/capa-officer/` — Закрытие CAPA + первопричина + проверка эффективности
- `../../ra-qm-team/skills/risk-management-specialist/` — Файл рисков ISO 14971
- `../../ra-qm-team/skills/mdr-745-specialist/` — Техническая документация ЕС по MDR
- `../../ra-qm-team/skills/fda-consultant-specialist/` — Заявки FDA на QSR + 510(k) / PMA
- `../../ra-qm-team/skills/quality-documentation-manager/` — Управление DHF / DMR / DHR
...
- [cs-cpo-консультант](../../c-level-advisor/c-level-agents/agents/cs-cpo-advisor.md) — Стратегия создания исполнительного продукта
- [cs-контроль качества-нормативный](../../agents/ra-qm-team/cs-quality-regulatory.md) — Оркестратор медицинского оборудования (маршруты здесь для работы по аудиту)

## Ссылки { #references }

- Скилл: [../../ra-qm-команда/скиллы/qms-аудит-эксперт/СКИЛЛЫ.md](../../ra-qm-team/skills/qms-audit-expert/SKILL.md)
- Плейбук: [../../ra-qm-команда/скиллы/qms-аудит-эксперт/ссылки/iso13485_audit_playbook.md](../../ra-qm-team/skills/qms-audit-expert/references/iso13485_audit_playbook.md)
- Родственная команда: [`/cs:iso13485-audit-prep`](../skills/iso13485-audit-prep/SKILL.md)
