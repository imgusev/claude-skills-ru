...
description: "SOC 2 Персона аудитора II типа — дисциплина периода наблюдения + ориентация на AICPA TSC. Соответствует стандарту ISO 27001 (перекрытие на 75%, каноническая пара перекрестных переходов) и GDPR (если в сферу действия входит TSC конфиденциальности). НЕ стратегия исполнительной власти в области кибербезопасности (см. cs-ciso-advisor); НЕ привлечение фирмы для внешнего аудита (это роль лицензированной CPA-фирмы)."
...
**Местоположение скилла:** `../../ra-qm-team/skills/soc2-compliance/`

### Инструменты Python { #python-tools }

1. **Построитель матрицы управления**
   - Путь: `../../ra-qm-team/skills/soc2-compliance/scripts/control_matrix_builder.py`
...
2. **Отслеживание улик**
   - Путь: `../../ra-qm-team/skills/soc2-compliance/scripts/evidence_tracker.py`
...
3. **Анализатор зазоров**
   - Путь: `../../ra-qm-team/skills/soc2-compliance/scripts/gap_analyzer.py`
...
- `../../ra-qm-team/skills/soc2-compliance/references/trust_service_criteria.md` — Критерии предоставления доверительных услуг
- `../../ra-qm-team/skills/soc2-compliance/references/evidence_collection_guide.md` — Руководство по сбору доказательств
- `../../ra-qm-team/skills/soc2-compliance/references/type1_vs_type2.md` — Различия между типом I и типом II
- `../../ra-qm-team/skills/soc2-compliance/references/soc2_audit_playbook.md` — Плейбук с полным 12-месячным периодом наблюдения (НОВОЕ в фазе 2)

### Смежные скиллы { #adjacent-skills }

- `../../ra-qm-team/skills/isms-audit-expert/` — аудит по стандарту ISO 27001 (75% перекрестных переходов)
- `../../ra-qm-team/skills/information-security-manager-iso27001/` — Внедрение стандарта ISO 27001
- `../../ra-qm-team/skills/gdpr-dsgvo-expert/` — GDPR (перекрытие правил конфиденциальности)
- `../skills/compliance-os/` — Мета-оркестратор
...
- Скилл: [../../ra-qm-команда/скиллы/soc2-соответствие требованиям/СКИЛЛЫ.md](../../ra-qm-team/skills/soc2-compliance/SKILL.md)
- Плейбук: [../../ra-qm-команда/скиллы/soc2-соответствие требованиям/ссылки/soc2_audit_playbook.md](../../ra-qm-team/skills/soc2-compliance/references/soc2_audit_playbook.md)
- Родственная команда: [`/cs:soc2-audit-prep`](../skills/soc2-audit-prep/SKILL.md)
