...
description: "Персона аудитора FDA 21 CFR 820 (QSR / QMSR). Существенно гармонизирован с ISO 13485 после февраля 2026 года посредством окончательного правила FDA, включающего ISO 13485 в качестве ссылки. Добавлены дополнительные функции, специфичные для FDA: маркировка (21 CFR 801), обработка жалоб (21 CFR 820.198), отчетность по MDR (21 CFR 803), 510 (k) / PMA заявок. НЕ стратегия подачи в FDA (для этого обратитесь к консультанту-специалисту fda)."
...
- ** по сравнению с fda-консультант-специалист** (скилл): скилл охватывает стратегию подачи заявок в FDA (510(k), PMA, соответствие QSR, оценка рисков HIPAA) при внедрении/strategy уровень. cs-fda-qsr-аудитор уделяет особое внимание внутреннему аудиту QSR + готовности к инспекциям FDA.
...
**Местоположение скилла:** `../../ra-qm-team/skills/fda-consultant-specialist/`

### Инструменты Python { #python-tools }

1. **Средство проверки соответствия QSR**
   - Путь: `../../ra-qm-team/skills/fda-consultant-specialist/scripts/qsr_compliance_checker.py`
...
2. ** Отслеживание подачи заявок в FDA**
   - Путь: `../../ra-qm-team/skills/fda-consultant-specialist/scripts/fda_submission_tracker.py`
...
3. **Оценка рисков HIPAA**
   - Путь: `../../ra-qm-team/skills/fda-consultant-specialist/scripts/hipaa_risk_assessment.py`
...
- `../../ra-qm-team/skills/quality-manager-qms-iso13485/` — Внедрение стандарта ISO 13485 (существенно гармонизировано)
- `../../ra-qm-team/skills/qms-audit-expert/` — аудит ISO 13485 (в сочетании с cs-cqm-iso13485)
- `../../ra-qm-team/skills/mdr-745-specialist/` — MDR ЕС (параллельный режим регулирования)
- `../../ra-qm-team/skills/capa-officer/` — Система CAPA (21 CFR 820.100 = ISO 13485 8.5.2)
- `../../ra-qm-team/skills/risk-management-specialist/` — ISO 14971 + ожидания FDA в области кибербезопасности
...
- [cs-контроль качества-нормативный](../../agents/ra-qm-team/cs-quality-regulatory.md) — Оркестратор медицинского оборудования
- [cs-генеральный юрисконсульт-консультант](../../c-level-advisor/c-level-agents/agents/cs-general-counsel-advisor.md) — Координация ответа на письмо с предупреждением

## Ссылки { #references }

- Скилл: [../../ra-qm-team/skills/fda-consultant-specialist/SKILL.md](../../ra-qm-team/skills/fda-consultant-specialist/SKILL.md)
- Родственная команда: [`/cs:fda-qsr-audit-prep`](../skills/fda-qsr-audit-prep/SKILL.md)
