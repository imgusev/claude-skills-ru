...
description: "Внедрение системы управления искусственным интеллектом ISO/IEC 42001:2023 (AIMS) + оператор внутреннего аудита. Три решения: Выявлять пробелы в соответствии с пунктами 4-10, регистрировать риски ИИ в соответствии с приложением A + ISO 23894, пункт 9.2 плана внутреннего аудита. НЕ стратегия исполнительного ИИ (см. cs-caio-advisor). НЕ соответствует Закону ЕС об ИИ (см. cs-ai-act-compliance)."
...
**Местоположение скилла:** `../../ra-qm-team/skills/iso42001-specialist/`

### Инструменты Python { #python-tools }

1. **Анализатор пробелов в целях**
   - Путь: `../../ra-qm-team/skills/iso42001-specialist/scripts/aims_gap_analyzer.py`
...
2. **Составитель реестра рисков искусственного интеллекта**
   - Путь: `../../ra-qm-team/skills/iso42001-specialist/scripts/ai_risk_register_builder.py`
...
3. **Планировщик целевого аудита**
   - Путь: `../../ra-qm-team/skills/iso42001-specialist/scripts/aims_audit_scheduler.py`
...
- `../../ra-qm-team/skills/iso42001-specialist/references/iso42001_clauses.md` — Пункты 4-10 пошагового руководства с доказательствами аудита + распространенные пробелы + повторное использование ISO 27001/13485
- `../../ra-qm-team/skills/iso42001-specialist/references/aims_controls_annex_a.md` — 38 Каталог средств контроля приложения A (A.2-A.10) с руководством по внедрению + доказательства аудита + степень серьезности сбоя.
- `../../ra-qm-team/skills/iso42001-specialist/references/aims_implementation_guide.md` — модель с 3-летним сроком погашения + шаблоны повторного использования ISO 27001/13485 + стоимость/effort контрольные показатели + распространенные подводные камни
- `../../ra-qm-team/skills/iso42001-specialist/references/cross_framework_mapping_ai.md` — 42001 ↔ Закон ЕС об ИИ ↔ NIST AI RMF ↔ 23894 ↔ 38507 ↔ 27001 пешеходный переход
...
- [cs-ciso-советник](../../c-level-advisor/c-level-agents/agents/cs-ciso-advisor.md) — Кибербезопасность руководителей (стратегия ISO 27001 / SOC 2)
- [cs-качество-нормативное регулирование](../../agents/ra-qm-team/cs-quality-regulatory.md) — Оркестратор системы менеджмента качества медицинского оборудования / регулирования

## Ссылки { #references }

- Скилл: [../../ra-qm-team/skills/iso42001-specialist/SKILL.md](../../ra-qm-team/skills/iso42001-specialist/SKILL.md)
- Родственная команда: [`/cs:aims-audit`](../skills/aims-audit/SKILL.md)
