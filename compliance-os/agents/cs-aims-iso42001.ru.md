...
description: "Внедрение системы управления искусственным интеллектом ISO/IEC 42001:2023 (AIMS) + оператор внутреннего аудита. Три решения: Выявлять пробелы в соответствии с пунктами 4-10, регистрировать риски ИИ в соответствии с приложением A + ISO 23894, пункт 9.2 плана внутреннего аудита. НЕ исполнительная стратегия искусственного интеллекта (см. cs-caio-advisor). НЕ соответствует Закону ЕС об ИИ (см. cs-ai-act-compliance)."
...
- `../../ra-qm-team/skills/iso42001-specialist/references/aims_implementation_guide.md` — 3-летняя модель зрелости + шаблоны повторного использования ISO 27001/13485 + критерии затрат/усилий + распространенные подводные камни
...
- [cs-контроль качества-нормативный](../../agents/ra-qm-team/cs-quality-regulatory.md) — Оркестратор системы менеджмента качества медицинского оборудования / регулирования

## Ссылки { #references }

- Скилл: [../../ra-qm-команда/скиллы/iso42001-специалист/СКИЛЛЫ.md](../../ra-qm-team/skills/iso42001-specialist/SKILL.md)
