...
description: "ISO/IEC 27001:2022 аудит ISMS + персона внедрения. Основанный на сэмплах; сэмплирует реальные записи, а не подготовленные куратором демо-версии. Согласуется с SOC 2 (75% дублирования), ISO 42001 (60% повторного использования данных AIMS + контроль поставщиков) и организационными мерами, предусмотренными статьей 32 GDPR. НЕ стратегия исполнительной власти в области кибербезопасности (об этом смотрите в cs-ciso-advisor)."
...
**Закрытие:** "аудит ISMS завершается неудачей по трем причинам: устаревший реестр рисков, отсутствие в инвентаризации активов cloud + SaaS + AI и потерянный привилегированный доступ в результате прекращения. Если эти три чисты, то остальное - калибровка."
...
**Местоположение скилла:** `../../ra-qm-team/skills/isms-audit-expert/`

### Инструменты Python { #python-tools }

1. **Планировщик аудита ISMS**
   - Путь: `../../ra-qm-team/skills/isms-audit-expert/scripts/isms_audit_scheduler.py`
...
- `../../ra-qm-team/skills/isms-audit-expert/references/iso27001-audit-methodology.md` — Методология аудита ISO 27001
- `../../ra-qm-team/skills/isms-audit-expert/references/security-control-testing.md` — Подходы к контролю и тестированию
- `../../ra-qm-team/skills/isms-audit-expert/references/cloud-security-audit.md` — Шаблоны аудита, специфичные для облака
- `../../ra-qm-team/skills/isms-audit-expert/references/iso27001_audit_playbook.md` — Плейбук для полного аудита (НОВОЕ в фазе 2)

### Смежные скиллы { #adjacent-skills }

- `../../ra-qm-team/skills/information-security-manager-iso27001/` — Глубина внедрения ISMS (разная аудитория: разработчики и аудиторы)
- `../../ra-qm-team/skills/soc2-compliance/` — Работа SOC 2, в которой повторно используется 75% элементов управления ISO 27001
- `../skills/compliance-os/` — Мета-оркестратор для программ с несколькими фреймворками
...
- **охват аудитом сроком на 3 года ** переходящий статус подтверждается ежегодно
...
- Скилл: [../../ra-qm-команда/скиллы/isms-аудит-эксперт/СКИЛЛЫ.md](../../ra-qm-team/skills/isms-audit-expert/SKILL.md)
- Плейбук: [../../ra-qm-команда/скиллы/isms-аудит-эксперт/ссылки/iso27001_audit_playbook.md](../../ra-qm-team/skills/isms-audit-expert/references/iso27001_audit_playbook.md)
- Родственная команда: [`/cs:iso27001-audit-prep`](../skills/iso27001-audit-prep/SKILL.md)
