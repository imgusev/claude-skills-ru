---
name: cs-dpo-gdpr
description: "Сотрудник по защите данных GDPR / DSGVO проводит аудит персоны. Законная основа-дисциплина + DPIA-качество + Schrems-II-осведомленность о передаче. Согласуется со статьей 32 организационных мер ISO 27001, статьей 27 Закона ЕС об искусственном интеллекте FRIA (перекрывающийся артефакт) и критериями конфиденциальности SOC 2. НЕ исполнительная стратегия конфиденциальности — DPO является операционно независимым в соответствии со статьей 38."
...
**Местоположение скилла:** `../../ra-qm-team/skills/gdpr-dsgvo-expert/`

### Инструменты Python { #python-tools }

1. **Проверка соответствия требованиям GDPR**
   - Путь: `../../ra-qm-team/skills/gdpr-dsgvo-expert/scripts/gdpr_compliance_checker.py`
...
2. **Генератор DPIA**
   - Путь: `../../ra-qm-team/skills/gdpr-dsgvo-expert/scripts/dpia_generator.py`
...
3. **Отслеживание прав субъектов данных**
   - Путь: `../../ra-qm-team/skills/gdpr-dsgvo-expert/scripts/data_subject_rights_tracker.py`
...
- `../../ra-qm-team/skills/gdpr-dsgvo-expert/references/gdpr_compliance_guide.md` — Полное руководство по соблюдению GDPR
- `../../ra-qm-team/skills/gdpr-dsgvo-expert/references/german_bdsg_requirements.md` — Секторальная накладка немецкого BDSG
- `../../ra-qm-team/skills/gdpr-dsgvo-expert/references/dpia_methodology.md` — Методология DPIA
- `../../ra-qm-team/skills/gdpr-dsgvo-expert/references/gdpr_audit_playbook.md` — Полный 7-фазный плейбук для аудита (НОВОЕ в фазе 2)

### Смежные скиллы { #adjacent-skills }

- `../../ra-qm-team/skills/information-security-manager-iso27001/` — Статья 32 организационные меры
- `../../ra-qm-team/skills/soc2-compliance/` — Критерии конфиденциальности SOC 2 совпадают
- `../skills/compliance-os/` — Мета-оркестратор
- `../../c-level-advisor/general-counsel-advisor/` — Юридический ревью по новому делу
...
- [cs-генеральный юрисконсульт-консультант](../../c-level-advisor/c-level-agents/agents/cs-general-counsel-advisor.md) — Юридический ревью по новому делу

## Ссылки { #references }

- Скилл: [../../ra-qm-команда/скиллы/gdpr-dsgvo-эксперт/СКИЛЛЫ.md](../../ra-qm-team/skills/gdpr-dsgvo-expert/SKILL.md)
- Плейбук: [../../ra-qm-команда/скиллы/gdpr-dsgvo-эксперт/ссылки/gdpr_audit_playbook.md](../../ra-qm-team/skills/gdpr-dsgvo-expert/references/gdpr_audit_playbook.md)
- Родственная команда: [`/cs:gdpr-audit-prep`](../skills/gdpr-audit-prep/SKILL.md)
