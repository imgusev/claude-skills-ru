...
description: "Закон ЕС об ИИ (Регламент (ЕС) 2024/1689), цитируемый в статье оператор по соблюдению требований. Три решения: Уровень риска системы искусственного интеллекта (статья 5/6+ Приложение III / 50 / минимальное), маршрут оценки соответствия (статья 43, модуль A против H + документы приложения IV), матрица обязательств для каждой роли (поставщик/развертыватель/импортер/дистрибьютор + GPAI). НЕ стратегия исполнительного ИИ (см. cs-caio-advisor). НЕ является юридической заменой (привлекайте адвоката для новых дел)."
...
**Местоположение скилла:** `../../ra-qm-team/skills/eu-ai-act-specialist/`

### Инструменты Python { #python-tools }

1. **Классификатор рисков системы искусственного интеллекта**
   - Путь: `../../ra-qm-team/skills/eu-ai-act-specialist/scripts/ai_system_risk_classifier.py`
...
2. **Планировщик оценки соответствия**
   - Путь: `../../ra-qm-team/skills/eu-ai-act-specialist/scripts/conformity_assessment_planner.py`
...
3. ** Отслеживание обязательств по действиям искусственного интеллекта**
   - Путь: `../../ra-qm-team/skills/eu-ai-act-specialist/scripts/ai_act_obligation_tracker.py`
...
- `../../ra-qm-team/skills/eu-ai-act-specialist/references/eu_ai_act_titles.md` — Пошаговое руководство по разделам I-XII с требованиями к уровню статей
- `../../ra-qm-team/skills/eu-ai-act-specialist/references/high_risk_systems_annex_iii.md` — 8 категорий высокого риска + статья 6(2)-(3) дерево решений + тест на исключение
- `../../ra-qm-team/skills/eu-ai-act-specialist/references/gpai_obligations.md` — Статьи 51-55 + Приложения XI-XIII + Кодекс практики + порог системного риска
- `../../ra-qm-team/skills/eu-ai-act-specialist/references/cross_framework_mapping_ai_act.md` — Закон об ИИ ↔ ISO 42001 ↔ NIST AI RMF ↔ Пересечение GDPR со статьей 17(1) постатейное сопоставление
...
- [cs-caio-советник](../../c-level-advisor/c-level-agents/agents/cs-caio-advisor.md) — Исполнительная стратегия искусственного интеллекта
...
- Скилл: [../../ra-qm-team/skills/eu-ai-act-specialist/SKILL.md](../../ra-qm-team/skills/eu-ai-act-specialist/SKILL.md)
- Родственная команда: [`/cs:ai-act-readiness`](../skills/ai-act-readiness/SKILL.md)
