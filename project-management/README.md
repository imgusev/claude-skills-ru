...
npx ai-agent-skills install imgusev/claude-skills-ru/project-management

# Install to Claude Code only
npx ai-agent-skills install imgusev/claude-skills-ru/project-management --agent claude

# Install to Cursor only
npx ai-agent-skills install imgusev/claude-skills-ru/project-management --agent cursor
```
...
npx ai-agent-skills install imgusev/claude-skills-ru/project-management/skills/senior-pm

# Scrum Master Expert
npx ai-agent-skills install imgusev/claude-skills-ru/project-management/skills/scrum-master

# Atlassian Jira Expert
npx ai-agent-skills install imgusev/claude-skills-ru/project-management/skills/jira-expert

# Atlassian Confluence Expert
npx ai-agent-skills install imgusev/claude-skills-ru/project-management/skills/confluence-expert

# Atlassian Administrator
npx ai-agent-skills install imgusev/claude-skills-ru/project-management/skills/atlassian-admin

# Atlassian Template Creator
npx ai-agent-skills install imgusev/claude-skills-ru/project-management/skills/atlassian-templates
```
