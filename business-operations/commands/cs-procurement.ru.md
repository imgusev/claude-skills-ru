---
description: "Категоризация расходов + рационализация поставщиков + анализ цикла закупок. НЕ оценка эффективности работы поставщика (родственное управление поставщиками). НЕ финансовое закрытие (finance). Прямое использование скилла оптимизатора закупок."
argument-hint: "<spend export path or category to analyze>"
---

# /cs:procurement — Провести аудит + консолидацию поставщиков { #csprocurement--spend-audit--supplier-consolidation }
