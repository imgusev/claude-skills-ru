...
description: "Скилл старшего специалиста по обработке данных мирового класса, специализирующегося на статистическом моделировании, разработке экспериментов, причинно-следственных связях и прогнозной аналитике. Охватывает A/B тестирование (определение размера выборки, z-тесты с двумя пропорциями, коррекция Бонферрони), определение различий в различиях, пайплайны проектирования функций (Scikit-learn, XGBoost), оценку перекрестной валидации модели (AUC-ROC, AUC-PR, SHAP) и отслеживание экспериментов MLflow с использованием Python (NumPy, Pandas, Scikit-learn), R и SQL. Используется при проектировании или анализе контролируемых экспериментов, построении и оценке классификационных или регрессионных моделей, выполнении причинно-следственного анализа данных наблюдений, разработке функций для структурированных табличных наборов данных или преобразовании статистических результатов в бизнес-решения, основанные на данных."
---

# Старший специалист по обработке данных { #senior-data-scientist }

Скилл старшего специалиста по обработке данных мирового класса для производственных систем искусственного интеллекта/ML/обработки данных.

## Основные воркфлоу { #core-workflows }

### 1. Разработайте A/B-тест { #1-design-an-ab-test }
...
### 2. Создайте пайплайн для разработки функциональных возможностей { #2-build-a-feature-engineering-pipeline }
...
### 3. Обучите, оцените и выберите модель прогнозирования { #3-train-evaluate-and-select-a-prediction-model }
...
### 4. Причинно-следственный вывод: Различие в различиях { #4-causal-inference-difference-in-differences }
...
- **Статистические методы:** `references/statistical_methods_advanced.md`
- **Фреймворки для экспериментального проектирования:** `references/experiment_design_frameworks.md`
- **Характерные инженерные паттерны:** `references/feature_engineering_patterns.md`
