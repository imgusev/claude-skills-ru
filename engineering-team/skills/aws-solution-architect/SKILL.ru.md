...
description: "Разрабатывайте архитектуры AWS для стартапов, используя бессерверные шаблоны и шаблоны IaC. Используйте, когда вас попросят спроектировать бессерверную архитектуру, создать шаблоны CloudFormation, оптимизировать затраты на AWS, настроить пайплайны CI/CD или перейти на AWS. Охватывает Lambda, API Gateway, DynamoDB, ECS, Aurora и оптимизацию затрат."
---
...
### Архитектура MVP (<100 долларов/month) { #mvp-architecture--100month }
...
### Масштабируемая архитектура ($500-2000/month) { #scaling-architecture-500-2000month }
...
| Бюджет | Ежемесячный лимит AWS | $500/month макс. |
