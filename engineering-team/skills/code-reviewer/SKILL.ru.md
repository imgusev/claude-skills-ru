---
name: "code-reviewer"
description: Автоматизация ревью кода для TypeScript, JavaScript, Python, Go, Swift, Kotlin, C#, .NET, Java, C, C++, Rust, Ruby, PHP и Dart/Flutter. Анализирует PR на сложность и риск, проверяет качество кода на наличие серьезных нарушений и запахов кода, генерирует отчеты о ревью. Используйте при ревью запросов на извлечение, анализе качества кода, выявлении проблем, создании чек-листов для ревью-запросов на извлечение.
---
