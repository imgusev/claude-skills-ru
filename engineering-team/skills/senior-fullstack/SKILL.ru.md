...
description: "Набор инструментов для разработки Fullstack с проектными рамками для Next.js , стеки FastAPI, MERN и Django, анализ качества кода с оценкой безопасности и сложности, а также рекомендации по выбору стека. Используйте, когда пользователь просит \"создать новый проект\", \"создать Next.js приложение\", \"настройка FastAPI с помощью React\", \"анализ качества кода\", \"аудит моей кодовой базы\", \"какой стек мне следует использовать\", \"сгенерировать шаблон проекта\" или упоминает разработку fullstack, проект настройка или сравнение технического стека."
---
