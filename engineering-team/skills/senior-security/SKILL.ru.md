...
| Враждебный/adversarial ревью кода | `../adversarial-reviewer/` | ревью 3-персоны с БЛОКИРОВКОЙ/ПРОБЛЕМАМИ/ЧИСТЫМ вердиктом |
...
| Документ | Содержание |
|----------|---------|
| [ссылки/threat-modeling-guide.md](references/threat-modeling-guide.md) | Методология STRIDE, деревья атак, оценка СТРАХА, создание DFD |
...
| [ссылки/cryptography-implementation.md](references/cryptography-implementation.md) | AES-GCM, Ed25519, хэширование паролей (Argon2id), управление ключами |
