...
description: "Используется при написании Snowflake SQL, построении пайплайнов данных с динамическими таблицами или потоками /задачами, использовании функций Cortex AI, создании агентов Cortex, написании Snowpark Python, настройке dbt для Snowflake или устранении ошибок Snowflake."
---
...
| `AI_EXTRACT` | Структурированное извлечение из текста/images/documents |
...
- Используйте сетевые политики для включения IP-адресов в список разрешенных.
...
- **Задача не возобновлена** после создания -- напоминает, что выполнение задач приостанавливается.
...
|-------|-------|-----|
| "Объект не существует" | Неправильная база данных/schema контекст или отсутствующие гранты | Имена, полностью соответствующие требованиям (`db.schema.table`), проверять гранты |
...
1. **Исходные данные этапа**: Создайте внешний этап, указывающий на S3/GCS/Azure, настройте Snowpipe для автоматического приема
