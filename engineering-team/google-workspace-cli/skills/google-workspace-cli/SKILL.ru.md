...
description: "Администрирование Google Workspace с помощью gws CLI (github.com/googleworkspace/cli ). Установите, аутентифицируйте и автоматизируйте Gmail, Диск, таблицы, календарь, документы, Чат и задачи. Проводите аудит безопасности и используйте локальные шаблоны рецептов и пакеты персон. Используйте для администрирования Google Workspace, настройки gws CLI, автоматизации Gmail, управления дисками или планирования календаря."
---
