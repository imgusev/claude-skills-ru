...
> Видишь [ссылки/framework-a11y-patterns.md](references/framework-a11y-patterns.md) для получения полного каталога шаблонов исправлений.
...
> Видишь [ссылки/examples-by-framework.md](references/examples-by-framework.md) для Vue, Angular, Next.js , и стройные примеры.
