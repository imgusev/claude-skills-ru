---
name: "playwright-pro"
description: "Набор инструментов для тестирования драматурга производственного уровня. Используйте, когда пользователь упоминает тесты драматурга, сквозное тестирование, автоматизацию браузера, исправление ошибочных тестов, миграцию тестов, тестирование CI/CD или наборы тестов. Генерируйте тесты, исправляйте случайные сбои, мигрируйте с Cypress/Selenium, синхронизируйте с TestRail, запускайте в BrowserStack. 55 шаблонов, 3 агента, интеллектуальная отчетность."
---
