---
name: "product-skills"
description: "Маршрутизатор / индекс для 12 скилл-продуктов, включенных в этот плагин (расстановка приоритетов RICE, OKR, исследование UX, маркеры дизайна, анализ конкурентов, аналитика, эксперименты, обнаружение, дорожные карты, спецификации для репозиториев, целевые страницы, SaaS-леса). Используйте, когда запрос на продукт явно не соответствует какому-либо скиллу и вам нужно выбрать правильный (например, \"помогите мне расставить приоритеты в функциях\", \"спланируйте эксперимент с продуктом\")."
version: 2.9.0
