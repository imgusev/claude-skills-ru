🇬🇧 Английский · 🇷🇺 [Русский](README.ru.md)
...
Добавьте маркетплейс с `/plugin marketplace add alirezarezvani/claude-skills`, затем установите любой пакет для скилла с `/plugin install <name>@claude-code-skills`.
