---
name: "merge"
description: "Объедините ветку победившего агента с базой, заархивируйте проигравших и очистите рабочие деревья. Используйте, когда пользователь запускает /hub:merge или запрашивает получение выигрышного результата AgentHub и приводит в порядок сеанс."
command: /hub:merge
---
