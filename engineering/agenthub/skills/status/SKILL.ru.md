---
name: "status"
description: "Показывать состояние DAG, прогресс агента и статус филиала для сеанса AgentHub. Используйте, когда пользователь запускает /hub:status или спрашивает, как дела у агентов AgentHub."
command: /hub:status
---
