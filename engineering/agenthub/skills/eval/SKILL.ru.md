---
name: "eval"
description: "Оценивайте и ранжируйте результаты агентов по показателям или LLM judge для сеанса AgentHub. Используется, когда пользователь запускает /hub:eval или запрашивает оценку, сравнение или выбор победителя среди завершенных агентов AgentHub."
command: /hub:eval
---
