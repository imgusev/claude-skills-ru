---
name: "board"
description: "Читайте, пишите и просматривайте доску объявлений AgentHub для координации действий агентов. Используется, когда пользователь запускает /hub:board или запрашивает публикацию, чтение или проверку сообщений о координации между конкурирующими агентами AgentHub."
command: /hub:board
---
