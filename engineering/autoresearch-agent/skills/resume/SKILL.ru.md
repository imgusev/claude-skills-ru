---
name: "resume"
description: "Возобновите приостановленный эксперимент. Проверьте ветку эксперимента, прочитайте историю результатов, продолжайте итерацию. Используйте, когда пользователь запускает /ar:resume или просит продолжить ранее запущенный эксперимент с автосервисом."
command: /ar:resume
---
