...
description: "/cs: напишите скилл <название или описание> — Создайте новый скилл агента с помощью трехэтапного воркфлоу Мэтта Покока (Сбор → Черновик → Ревью). Запускает 6 элементов чек-листа для ревью + 3 инструмента проверки в качестве гейта. Используйте при запуске нового скилла в этом репозитории."
---

# /cs:написать-скилл — Скилл-автор форсирует вопросы { #cswrite-a-skill--skill-author-forcing-questions }
...
- Выберите что-то одно: агента ИЛИ бота, скилл ИЛИ инструмент, пользователя ИЛИ разработчика
...
- Идеально хороший/плохой контраст (рисунок Мэтта)
...
- Агент: [`cs-skill-author`](../agents/cs-skill-author.md)
- Скилл: [`write-a-skill`](../skills/write-a-skill/SKILL.md)
- Смежный: `../../karpathy-coder/`, `../../autoresearch-agent/`
