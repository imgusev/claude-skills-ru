...
# /cs:handoff — Хэндофф сеанса { #cshandoff--session-handoff }
...
- Передача работы другой команде/person/agent
...
|---|---|
| корабль/deploy/PR | Команды развертывания, проверки, утверждения, откат |
| ревью/audit | Чек-лист, конфиденциальные файлы, похожие шаблоны |
| отладка/fix/investigate | Симптом, повторные шаги, уже опробовано |
| дизайн/plan/scope | Результат, ограничения, отвергнутые альтернативы |
| тест/qa | План тестирования, существующее покрытие, крайние случаи |
