---
name: "collab-proof"
description: "Используйте, когда вы хотите понять, какой вклад внес Клод в сравнении с тем, что вы использовали во время сеанса. Триггеры для: /collab-proof, ретроспектива сессии, анализ вклада искусственного интеллекта, доказательства сотрудничества, что сделал Клод."
license: MIT
---
...
- Никаких изменений кода, только планирование/discussion, ИЛИ
...
- `1.0` Новый модуль/file создана, добавлена сложная логика (конечный автомат, Lua-скрипт, новый алгоритм)
...
**Рамка C — Fork** (наличие ветви принятия решения)
...
- `1.0` Клод обнаружил ошибку/edge случай, когда разработчик не заметил этого и предложил исправление
- `0.6` Клод сгенерировал структурный шаблон/skeleton это значительно ускорило выполнение
...
Сократите оценку любого кадра < 0,4.
...
Это сеанс создания шаблонных функций. Немедленно классифицировать как `FEATURE_BUILDING` с `HIGH` сигнал.
