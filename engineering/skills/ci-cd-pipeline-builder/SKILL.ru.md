...
- [ссылки/пайплайн-дизайн-примечания.md](references/pipeline-design-notes.md) — распространенные подводные камни, лучшие практики, эвристики обнаружения, стратегия генерации, заметки о решениях платформы, чек-лист проверки перед слиянием и рекомендации по масштабированию
- [ссылки/github-actions-шаблоны.md](references/github-actions-templates.md)
- [ссылки/gitlab-ci-шаблоны.md](references/gitlab-ci-templates.md)
- [ссылки/развертывание-гейты.md](references/deployment-gates.md)
- [README.md](README.md)
