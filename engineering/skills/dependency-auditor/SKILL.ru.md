...
description: "Аудит и управление зависимостями в многоязычных проектах. Определяет уязвимости, конфликты лицензий, риски переходных зависимостей и пути безопасного обновления. Используйте при аудите пакетов сторонних производителей перед выпуском, изучении CVE, планировании масштабного обновления версии или проведении ревью на соответствие лицензии. Примеры: \"аудит наших зависимостей npm\", \"есть ли у нас заражение GPL\", \"планируйте обновление до React 19\"."
---
...
Видишь [README.md](README.md) для подробного использования и `references/` за уязвимость/license базы знаний.
