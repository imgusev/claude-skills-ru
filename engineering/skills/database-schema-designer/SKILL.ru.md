...
description: "Используется, когда пользователь запрашивает создание диаграмм ERD, нормализацию схем базы данных, проектирование связей таблиц или планирование миграции схем."
---
...
→ Смотрите ссылки/full-schema-examples.md для получения подробной информации
...
3. **Журнал аудита на соответствие требованиям** — ведение журнала перед/after JSON для регулируемых доменов
