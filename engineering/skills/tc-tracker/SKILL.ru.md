---
name: "tc-tracker"
description: "Используйте, когда пользователь просит отслеживать технические изменения, создавать записи изменений, управлять жизненными циклами TC или передавать работу между сеансами искусственного интеллекта. Охватывает воркфлоу инициализации/создания/обновления/статуса/возобновления/закрытия/экспорта для структурированной документации по изменению кода."
---
...
> Видишь [ссылки/lifecycle.md](references/lifecycle.md) для получения полной таблицы переходов и потоков восстановления.
...
> Видишь [ссылки/tc-schema.md](references/tc-schema.md) для получения полной схемы.
...
> Видишь [список литературы/хэндофф-format.md](references/handoff-format.md) ознакомьтесь с полной структурой и правилами заполнения.
...
- [ссылки/tc-schema.md](references/tc-schema.md) — Полная схема JSON для записей TC и реестра.
- [ссылки/lifecycle.md](references/lifecycle.md) — Конечный автомат, допустимые переходы и потоки восстановления.
- [список литературы/хэндофф-format.md](references/handoff-format.md) — Структура хэндоффа сессии и лучшие практики.
