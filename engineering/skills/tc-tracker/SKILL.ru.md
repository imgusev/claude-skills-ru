...
> Видишь [ссылки/handoff-format.md](references/handoff-format.md) ознакомьтесь с полной структурой и правилами заполнения.
...
- [ссылки/handoff-format.md](references/handoff-format.md) — Структура хэндоффа сессии и лучшие практики.
