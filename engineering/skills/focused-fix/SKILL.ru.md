---
name: "focused-fix"
description: "Используйте, когда пользователь просит исправить, отладить или заставить определенную функцию/модуль/область работать от начала до конца. Триггеры: \"заставьте X работать\", \"исправьте функцию Y\", \"модуль Z сломан\", \"сфокусируйтесь на [области]\". Не для быстрого исправления отдельных ошибок - это для систематического глубокого исправления всех файлов и зависимостей."
---
