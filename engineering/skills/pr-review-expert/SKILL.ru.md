...
description: "Используйте, когда пользователь запрашивает ревью запросов на извлечение, анализ изменений кода, проверку на наличие проблем с безопасностью в PR или оценку качества кода различий."
---
...
выполняет анализ радиуса поражения, сканирование безопасности, обнаружение критических изменений и расчет дельты покрытия тестами
. Подготавливает готовый для рецензента отчет с более чем чек-листом из 30 пунктов и приоритетными выводами.
...
- Автор/payments пути → требуется 100% покрытие
...
- **Косвенное раскрытие секретов** — секреты в сообщениях об ошибках/logs, а не просто жестко закодированные значения
