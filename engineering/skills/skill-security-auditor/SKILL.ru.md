...
|-------|-------------|----------|
| **Известные уязвимости** | Перекрестная ссылка с PyPI/npm консультативные базы данных | Критические 🔴  |
...
3. **Интерпретация вердикта:**
   ...
   - **⚠️ ПРЕДУПРЕЖДЕНИЕ** — Высокий/medium обнаруженные находки. Ревью вручную перед установкой.
...
Полную модель угроз, схемы обнаружения и известные векторы атак на скиллы агентов искусственного интеллекта смотрите в разделе [ссылки/threat-model.md](references/threat-model.md).
