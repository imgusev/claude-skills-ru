...
description: "Список из 37 скилл продвинутых инженерных агентов для Claude Code, Codex, Gemini CLI, Cursor, OpenClaw. Используйте при просмотре или выборе среди высокоуровневых инженерных скилл: проектирование агентов, RAG, MCP-серверы, CI /CD, проектирование баз данных, наблюдаемость, аудит безопасности, автоматизация регистрации изменений / релизов, надежность (SLO / хаос / флаги / операторы), управление платформой."
version: 2.9.0
