...
description: "Создавайте согласованные, проверяемые примечания к выпуску на основе обычных коммитов. Разделяет синтаксический анализ фиксации, логику семантического изменения и рендеринг журнала изменений для автоматизированных выпусков с редакторским контролем. Используйте при вырезании выпуска, генерируя CHANGELOG.md из истории git, вычисление следующей семантической версии на основе коммитов, автоматизация заметок о выпуске в CI или планирование исправления / отката. Примеры: \"сгенерировать журнал изменений для версии 1.4.0\", \"какой скачок версии требуется для этих коммитов\", \"нам нужен процесс экстренного исправления\"."
---
...
Когда выпуск идет не так, как надо, классифицируйте, прежде чем действовать (полные процедуры в [ссылки/исправление-procedures.md](references/hotfix-procedures.md)):
...
Предпочтительная функция - отключение флага при откате кода; откат базы данных выполняется только для неразрушающих миграций (предпочтительны миграции только вперед). Видишь [ссылки/исправление-procedures.md](references/hotfix-procedures.md).

## Ссылки { #references }

- [список литературы/ci-integration.md](references/ci-integration.md)
- [ссылки/список изменений-форматирование-guide.md](references/changelog-formatting-guide.md)
- [список литературы/monorepo-strategy.md](references/monorepo-strategy.md)
- [ссылки/исправление-procedures.md](references/hotfix-procedures.md)
- [README.md](README.md)
