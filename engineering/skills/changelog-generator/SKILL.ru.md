...
Когда выпуск идет не так, как надо, классифицируйте, прежде чем действовать (полные процедуры в [ссылки/hotfix-procedures.md](references/hotfix-procedures.md)):
...
Предпочтительная функция - отключение флага при откате кода; откат базы данных выполняется только для неразрушающих миграций (предпочтительны миграции только вперед). Видишь [ссылки/hotfix-procedures.md](references/hotfix-procedures.md).

## Ссылки { #references }

- [ссылки/ci-integration.md](references/ci-integration.md)
- [ссылки/changelog-formatting-guide.md](references/changelog-formatting-guide.md)
- [ссылки/monorepo-strategy.md](references/monorepo-strategy.md)
- [ссылки/hotfix-procedures.md](references/hotfix-procedures.md)
- [README.md](README.md)
