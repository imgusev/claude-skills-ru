---
name: "skill-tester"
description: "Подтверждайте, тестируйте и оценивайте качество скиллы в рамках экосистемы claude-скиллы. Комплексный мета-скилл: проверка структуры, тестирование скриптов на Python (синтаксис + импорт + среда выполнения + формат вывода), многомерная оценка качества с помощью буквенных оценок и классификации уровней (БАЗОВЫЙ / СТАНДАРТНЫЙ / МОЩНЫЙ). Используйте при разработке нового скилла, аудите существующих скиллы для продвижения по уровням, настройке перехватчиков предварительной фиксации для проверки качества скилла или интеграции контроля качества скилла в CI."
---
