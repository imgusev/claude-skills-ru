...
- `../skills/pulse/references/research_pack_conventions.md` — Канон правил честности агента (более 7 источников)
- `../skills/pulse/references/cross_platform_synthesis.md` — консенсус/controversy/pain обнаружение на разных платформах (более 7 источников)
- `../skills/pulse/references/parallel_execution_discipline.md` — 1 вопрос/sec обоснование + сигналы уровня плана (более 7 источников)
...
- Скилл: [../skills/pulse/SKILL.md](../skills/pulse/SKILL.md)
